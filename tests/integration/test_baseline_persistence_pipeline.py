    ...
    def test_baseline_persistence_improves_predictions(self, baseline_repository):
        ...
        for day in range(7):
            result = pipeline.process_health_data(
                ...
                activity_records=[a for a in week1_activity if a.date == week1_sleep[day].date],
                heart_records=[h for h in week1_hr if h.timestamp.date() == week1_sleep[day].date],
        ...
        for day in range(7):
            result = pipeline.process_health_data(
                ...
                activity_records=[a for a in week2_activity if a.date == week2_sleep[day].date],
                heart_records=[h for h in week2_hr if h.timestamp.date() == week2_sleep[day].date],
        ...
        for day in range(7):
            result = pipeline.process_health_data(
                ...
                activity_records=[a for a in week3_activity if a.date == week3_sleep[day].date],
                heart_records=[h for h in week3_hr if h.timestamp.date() == week3_sleep[day].date],
