...
class TestPipelinePersonalCalibration:
    ...
    @patch('big_mood_detector.infrastructure.fine_tuning.personal_calibrator.PersonalCalibrator.load')
    ...
    def test_pipeline_saves_predictions_with_personal_context(self, tmp_path):
        ...
        assert metadata.get("personal_calibration", {}).get("baseline_available") is True
