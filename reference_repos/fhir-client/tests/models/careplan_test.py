...
class CarePlanTests(unittest.TestCase):
    ...
    def implCarePlan3(self, inst):
        ...
        self.assertEqual(
            inst.activity[0].detail.scheduledPeriod.end.datetime,
            FHIRDateTime("2013-01-01T10:50:00+00:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[0].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2013-01-01T10:38:00+00:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.period.start.datetime,
            FHIRDateTime("2013-01-01T10:30:00+00:00").datetime,
        )
    ...
    def implCarePlan4(self, inst):
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2011-07-06").datetime
        )
    ...
    def implCarePlan5(self, inst):
        ...
        self.assertEqual(
            inst.activity[0].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[0].progress[0].time.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[1].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[1].progress[0].time.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[2].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[3].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-08-27").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[3].progress[0].time.datetime,
            FHIRDateTime("2012-08-27").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[3].progress[1].time.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[4].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-23").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[4].progress[0].time.datetime,
            FHIRDateTime("2012-08-13").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[4].progress[1].time.datetime,
            FHIRDateTime("2012-09-10").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[5].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-23").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[6].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-23").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[6].progress[0].time.datetime,
            FHIRDateTime("2012-08-13").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[6].progress[1].time.datetime,
            FHIRDateTime("2012-08-27").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[7].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-10").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[7].progress[0].time.datetime,
            FHIRDateTime("2012-07-23").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[8].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-23").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[8].progress[0].time.datetime,
            FHIRDateTime("2012-07-30").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[8].progress[1].time.datetime,
            FHIRDateTime("2012-08-13").datetime,
        )
        ...
        self.assertEqual(
            inst.activity[9].detail.scheduledPeriod.start.datetime,
            FHIRDateTime("2012-07-10").datetime,
        )
        self.assertEqual(
    ...
    def implCarePlan6(self, inst):
        ...
        self.assertEqual(inst.activity[1].detail.kind, "Appointment")
        self.assertEqual(
            inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.end.datetime,
            FHIRDateTime("2013-02-28").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2013-02-14").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[2].detail.code.text, "Follow-up Antenatal encounter"
        )
        self.assertEqual(
            inst.activity[2].detail.description,
        ...
        self.assertEqual(
            inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.end.datetime,
            FHIRDateTime("2013-03-14").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2013-03-01").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.end.datetime,
            FHIRDateTime("2013-09-14").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2013-09-01").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.extension[0].valueDateTime.datetime,
            FHIRDateTime("2013-01-01").datetime,
        )
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2013-01-01").datetime
        )
    ...
    def implCarePlan7(self, inst):
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2013-03-11").datetime
        )
    ...
    def implCarePlan8(self, inst):
        ...
        self.assertEqual(
            inst.period.end.datetime, FHIRDateTime("2013-03-08T09:30:10+01:00").datetime
        )
        self.assertEqual(inst.period.end.as_json(), "2013-03-08T09:30:10+01:00")
        self.assertEqual(
            inst.period.start.datetime,
            FHIRDateTime("2013-03-08T09:00:10+01:00").datetime,
        )
    ...
    def implCarePlan9(self, inst):
        ...
        self.assertEqual(
            inst.activity[0].detail.code.coding[0].display, "Weight Measured"
        )
        self.assertEqual(
            inst.activity[0].detail.code.coding[0].system, "http://loinc.org"
        )
        ...
        self.assertEqual(
            inst.activity[0].detail.code.coding[1].system, "http://snomed.info/sct"
        )
        self.assertFalse(inst.activity[0].detail.doNotPerform)
        ...
        self.assertEqual(
            inst.activity[0].outcomeCodeableConcept[0].coding[0].code, "161832001"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.instantiatesUri[0], "http://example.org/protocol-for-obesity"
        )
        self.assertEqual(inst.intent, "plan")
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
    ...
    def implCarePlan10(self, inst):
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2011-06-26").datetime
        )
