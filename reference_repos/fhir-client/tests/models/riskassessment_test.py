...
class RiskAssessmentTests(unittest.TestCase):
    ...
    def implRiskAssessment1(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Assessment of risk for disease (procedure)"
        )
        ...
        self.assertEqual(
            inst.prediction[0].outcome.text, "Unknown risk of developing breast cancer"
        )
    ...
    def implRiskAssessment2(self, inst):
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2006-01-13T23:01:00Z").datetime,
        )
    ...
    def implRiskAssessment4(self, inst):
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime,
            FHIRDateTime("2014-07-19T16:04:00Z").datetime,
        )
    ...
    def implRiskAssessment5(self, inst):
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2010-11-22").datetime
        )
        ...
        self.assertEqual(
            inst.prediction[0].qualitativeRisk.coding[0].display, "moderate likelihood"
        )
        self.assertEqual(
