...
class ImmunizationRecommendationTests(unittest.TestCase):
    ...
    def implImmunizationRecommendation1(self, inst):
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2015-02-09T11:04:15.817-05:00").datetime
        )
        ...
        self.assertEqual(
            inst.recommendation[0].dateCriterion[0].value.datetime,
            FHIRDateTime("2015-12-01T00:00:00-05:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.recommendation[0].dateCriterion[1].value.datetime,
            FHIRDateTime("2015-12-01T00:00:00-05:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.recommendation[0].dateCriterion[2].value.datetime,
            FHIRDateTime("2016-12-28T00:00:00-05:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.recommendation[0].description, "First sequence in protocol"
        )
        ...
        self.assertEqual(
            inst.recommendation[0].vaccineCode[0].coding[0].code, "14745005"
        )
        self.assertEqual(
            inst.recommendation[0].vaccineCode[0].coding[0].display,
            "Hepatitis A vaccine",
        )
        self.assertEqual(
    ...
    def implImmunizationRecommendation2(self, inst):
        ...
        self.assertEqual(
            inst.recommendation[0].dateCriterion[0].code.coding[0].code, "30981-5"
        )
        self.assertEqual(
            inst.recommendation[0].dateCriterion[0].code.coding[0].display,
