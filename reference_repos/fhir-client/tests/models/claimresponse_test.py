...
class ClaimResponseTests(unittest.TestCase):
    ...
    def implClaimResponse1(self, inst):
        ...
        self.assertEqual(
            inst.addItem[0].adjudication[0].category.coding[0].code, "eligible"
        )
        ...
        self.assertEqual(
            inst.addItem[0].adjudication[1].category.coding[0].code, "copay"
        )
        self.assertEqual(
            inst.addItem[0].adjudication[2].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.addItem[0].adjudication[3].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.addItem[1].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.addItem[1].adjudication[1].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.addItem[1].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.addItem[1].productOrService.coding[0].display,
        ...
        self.assertEqual(
            inst.processNote[0].language.coding[0].system, "urn:ietf:bcp:47"
        )
    ...
    def implClaimResponse2(self, inst):
        ...
        self.assertEqual(
            inst.item[0].adjudication[0].category.coding[0].code, "eligible"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[2].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[3].category.coding[0].code, "benefit"
        )
        self.assertEqual(inst.item[0].adjudication[3].reason.coding[0].code, "ar002")
        self.assertEqual(
            inst.item[0].adjudication[3].reason.coding[0].display, "Plan Limit Reached"
        )
        self.assertEqual(
    ...
    def implClaimResponse3(self, inst):
        ...
        self.assertEqual(
            inst.addItem[0].adjudication[3].reason.coding[0].display,
            "Plan Limit Reached",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.addItem[1].productOrService.coding[0].display, "Radiograph, bytewing"
        )
        self.assertEqual(
            inst.addItem[1].productOrService.coding[0].system,
            "http://example.org/fhir/oralservicecodes",
        ...
        self.assertEqual(
            inst.addItem[2].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.addItem[2].adjudication[1].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.addItem[2].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[1].category.coding[0].code, "benefit"
        )
        self.assertEqual(inst.item[0].itemSequence, 1)
        ...
        self.assertEqual(
            inst.item[1].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.item[1].adjudication[1].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.item[1].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[2].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.item[2].adjudication[1].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.item[2].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[2].detail[0].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.item[2].detail[0].adjudication[1].category.coding[0].code,
            "eligpercent",
        )
        ...
        self.assertEqual(
            inst.item[2].detail[0].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[2].detail[1].adjudication[0].category.coding[0].code, "eligible"
        )
        ...
        self.assertEqual(
            inst.item[2].detail[1].adjudication[1].category.coding[0].code, "benefit"
        )
    ...
    def implClaimResponse5(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://thebenefitcompany.com/claimresponse"
        )
        ...
        self.assertEqual(
            inst.item[0].detail[0].adjudication[0].category.coding[0].code, "eligible"
        )
        ...
        self.assertEqual(
            inst.item[0].detail[0].adjudication[1].category.coding[0].code, "copay"
        )
        self.assertEqual(
            inst.item[0].detail[0].adjudication[2].category.coding[0].code,
            "eligpercent",
        )
        ...
        self.assertEqual(
            inst.item[0].detail[0].adjudication[3].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[0].detail[1].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.item[0].detail[1].adjudication[1].category.coding[0].code,
            "eligpercent",
        )
        ...
        self.assertEqual(
            inst.item[0].detail[1].adjudication[2].category.coding[0].code, "benefit"
        )
        self.assertEqual(inst.item[0].detail[1].detailSequence, 2)
        self.assertEqual(inst.item[0].detail[1].noteNumber[0], 1)
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].adjudication[0].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].adjudication[2].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].adjudication[0].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].adjudication[2].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].adjudication[0].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].adjudication[2].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[2].adjudication[0].category.coding[0].code, "eligible"
        )
        self.assertEqual(
            inst.item[0].detail[2].adjudication[1].category.coding[0].code,
            "eligpercent",
        )
        ...
        self.assertEqual(
            inst.item[0].detail[2].adjudication[2].category.coding[0].code, "benefit"
        )
