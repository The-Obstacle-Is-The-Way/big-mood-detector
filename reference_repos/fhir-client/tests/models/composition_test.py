...
class CompositionTests(unittest.TestCase):
    ...
    def implComposition1(self, inst):
        ...
        self.assertEqual(
            inst.attester[0].time.datetime,
            FHIRDateTime("2012-01-04T09:10:14Z").datetime,
        )
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2018-10-30T16:56:04+11:00").datetime
        )
        ...
        self.assertEqual(
            inst.section[0].code.coding[0].system, "http://acme.org/codes/SectionType"
        )
        ...
        self.assertEqual(
            inst.section[1].code.coding[0].system, "http://acme.org/codes/SectionType"
        )
    ...
    def implComposition2(self, inst):
        ...
        self.assertEqual(inst.confidentiality, "N")
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2012-01-04T09:10:14Z").datetime
        )
        ...
        self.assertEqual(
            inst.event[0].period.end.datetime, FHIRDateTime("2012-11-12").datetime
        )
        self.assertEqual(inst.event[0].period.end.as_json(), "2012-11-12")
        self.assertEqual(
            inst.event[0].period.start.datetime, FHIRDateTime("2010-07-18").datetime
        )
