...
class ProvenanceTests(unittest.TestCase):
    ...
    def implProvenance1(self, inst):
        ...
        self.assertEqual(
            inst.occurredPeriod.start.datetime, FHIRDateTime("2016-11-30").datetime
        )
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2016-12-01T08:12:14+10:00").datetime
        )
    ...
    def implProvenance2(self, inst):
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2015-08-27T08:39:24+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.signature[0].when.datetime,
            FHIRInstant("2015-08-27T08:39:24+10:00").datetime,
        )
    ...
    def implProvenance3(self, inst):
        ...
        self.assertEqual(
            inst.occurredPeriod.start.datetime, FHIRDateTime("2017-06-06").datetime
        )
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2016-06-09T08:12:14+10:00").datetime
        )
    ...
    def implProvenance4(self, inst):
        ...
        self.assertEqual(
            inst.occurredPeriod.end.datetime, FHIRDateTime("2015-06-28").datetime
        )
        self.assertEqual(inst.occurredPeriod.end.as_json(), "2015-06-28")
        self.assertEqual(
            inst.occurredPeriod.start.datetime, FHIRDateTime("2015-06-27").datetime
        )
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2015-06-27T08:39:24+10:00").datetime
        )
