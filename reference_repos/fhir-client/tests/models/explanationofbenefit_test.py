...
class ExplanationOfBenefitTests(unittest.TestCase):
    ...
    def implExplanationOfBenefit1(self, inst):
        ...
        self.assertEqual(
            inst.billablePeriod.end.datetime, FHIRDateTime("2014-03-01").datetime
        )
        self.assertEqual(inst.billablePeriod.end.as_json(), "2014-03-01")
        self.assertEqual(
            inst.billablePeriod.start.datetime, FHIRDateTime("2014-02-01").datetime
        )
        ...
        self.assertEqual(
            inst.procedure[0].date.datetime, FHIRDateTime("2014-02-14").datetime
        )
        self.assertEqual(inst.procedure[0].date.as_json(), "2014-02-14")
        self.assertEqual(
            inst.procedure[0].procedureCodeableConcept.coding[0].code, "123001"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.related[0].reference.system, "http://www.BenefitsInc.com/case-number"
        )
        ...
        self.assertEqual(
            inst.supportingInfo[0].category.coding[0].code, "employmentimpacted"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.supportingInfo[0].timingPeriod.end.datetime,
            FHIRDateTime("2014-02-28").datetime,
        )
        self.assertEqual(
            inst.supportingInfo[0].timingPeriod.end.as_json(), "2014-02-28"
        )
        self.assertEqual(
            inst.supportingInfo[0].timingPeriod.start.datetime,
            FHIRDateTime("2014-02-14").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.supportingInfo[1].timingPeriod.end.datetime,
            FHIRDateTime("2014-02-16").datetime,
        )
        self.assertEqual(
            inst.supportingInfo[1].timingPeriod.end.as_json(), "2014-02-16"
        )
        self.assertEqual(
            inst.supportingInfo[1].timingPeriod.start.datetime,
            FHIRDateTime("2014-02-14").datetime,
        )
        self.assertEqual(
    ...
    def implExplanationOfBenefit2(self, inst):
        ...
        self.assertEqual(
            inst.item[0].adjudication[1].category.coding[0].code, "eligpercent"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[2].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[1].adjudication[0].category.coding[0].code, "benefit"
        )
        ...
        self.assertEqual(
            inst.item[1].detail[0].adjudication[0].category.coding[0].code, "benefit"
        )
        self.assertEqual(inst.item[1].detail[0].net.currency, "USD")
        self.assertEqual(inst.item[1].detail[0].net.value, 200.0)
        self.assertEqual(
            inst.item[1].detail[0].productOrService.coding[0].code, "group"
        )
        self.assertEqual(inst.item[1].detail[0].sequence, 1)
        self.assertEqual(
            inst.item[1].detail[0].subDetail[0].adjudication[0].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].detail[0].subDetail[0].adjudication[2].amount.currency, "USD"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].detail[0].subDetail[0].productOrService.coding[0].code, "1205"
        )
        self.assertEqual(
