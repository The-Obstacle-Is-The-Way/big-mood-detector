...
class ImagingStudyTests(unittest.TestCase):
    ...
    def implImagingStudy1(self, inst):
        ...
        self.assertEqual(
            inst.series[0].instance[0].sopClass.code,
            "urn:oid:1.2.840.10008.5.1.4.1.1.2",
        )
        self.assertEqual(
            inst.series[0].instance[0].sopClass.system, "urn:ietf:rfc:3986"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.started.datetime, FHIRDateTime("2011-01-01T11:01:20+03:00").datetime
        )
    ...
    def implImagingStudy2(self, inst):
        ...
        self.assertEqual(
            inst.modality[0].system, "http://dicom.nema.org/resources/ontology/DCM"
        )
        ...
        self.assertEqual(
            inst.procedureCode[0].coding[0].system, "http://www.radlex.org"
        )
        ...
        self.assertEqual(
            inst.series[0].instance[1].sopClass.code,
            "urn:oid:1.2.840.10008.5.1.4.1.1.2",
        )
        self.assertEqual(
            inst.series[0].instance[1].sopClass.system, "urn:ietf:rfc:3986"
        )
        ...
        self.assertEqual(
            inst.series[0].started.datetime,
            FHIRDateTime("2011-01-01T11:01:20+03:00").datetime,
        )
        ...
        self.assertEqual(
            inst.started.datetime, FHIRDateTime("2017-01-01T11:01:20+03:00").datetime
        )
