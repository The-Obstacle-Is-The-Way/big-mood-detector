...
class BasicTests(unittest.TestCase):
    ...
    def implBasic1(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://goodhealth.org/basic/identifiers"
        )
        ...
        self.assertEqual(
            inst.modifierExtension[1].valuePeriod.end.datetime,
            FHIRDateTime("2013-04-15").datetime,
        )
        self.assertEqual(
            inst.modifierExtension[1].valuePeriod.end.as_json(), "2013-04-15"
        )
        self.assertEqual(
            inst.modifierExtension[1].valuePeriod.start.datetime,
            FHIRDateTime("2013-04-01").datetime,
        )
        self.assertEqual(
