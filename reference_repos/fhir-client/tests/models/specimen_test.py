...
class SpecimenTests(unittest.TestCase):
    ...
    def implSpecimen1(self, inst):
        ...
        self.assertEqual(
            inst.collection.bodySite.coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(inst.collection.bodySite.text, "Right median cubital vein")
        self.assertEqual(
            inst.collection.collectedDateTime.datetime,
            FHIRDateTime("2011-05-30T06:15:00Z").datetime,
        )
        self.assertEqual(
    ...
    def implSpecimen2(self, inst):
        ...
        self.assertEqual(
            inst.collection.collectedDateTime.datetime,
            FHIRDateTime("2015-08-18T07:03:00Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.processing[0].description, "Acidify to pH < 3.0 with 6 N HCl."
        )
        ...
        self.assertEqual(
            inst.processing[0].timeDateTime.datetime,
            FHIRDateTime("2015-08-18T08:10:00Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.type.coding[0].system, "http://terminology.hl7.org/CodeSystem/v2-0487"
        )
    ...
    def implSpecimen3(self, inst):
        self.assertEqual(
            inst.accessionIdentifier.system, "https://vetmed.iastate.edu/vdl"
        )
        self.assertEqual(inst.accessionIdentifier.value, "20171120-1234")
        self.assertEqual(
            inst.collection.collectedDateTime.datetime,
            FHIRDateTime("2017-11-14").datetime,
        )
        ...
        self.assertEqual(
            inst.container[0].type.coding[0].system, "https://vetmed.iastate.edu/vdl"
        )
    ...
    def implSpecimen4(self, inst):
        self.assertEqual(
            inst.accessionIdentifier.system, "http://acme.com/labs/accession-ids"
        )
        self.assertEqual(inst.accessionIdentifier.value, "20150816-00124")
        self.assertEqual(
            inst.collection.collectedDateTime.datetime,
            FHIRDateTime("2015-08-16T06:40:17Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.container[0].type.coding[0].display, "Serum Separator Tube"
        )
        self.assertEqual(
            inst.container[0].type.coding[0].system, "http://acme.com/labs"
        )
    ...
    def implSpecimen5(self, inst):
        ...
        self.assertEqual(
            inst.collection.collectedDateTime.datetime,
            FHIRDateTime("2015-08-16T07:03:00Z").datetime,
        )
        self.assertEqual(
