...
class TestReportTests(unittest.TestCase):
    ...
    def implTestReport1(self, inst):
        ...
        self.assertEqual(
            inst.issued.datetime, FHIRDateTime("2016-10-07T08:25:34-05:00").datetime
        )
        ...
        self.assertEqual(
            inst.participant[1].uri, "http://fhir3.healthintersections.com.au/open"
        )
        ...
        self.assertEqual(
            inst.setup.action[2].operation.message,
            "POST Patient/fixture-patient-create",
        )
        ...
        self.assertEqual(
            inst.test[0].action[0].operation.message,
            "GET Patient/fixture-patient-create",
        )
        ...
        self.assertEqual(
            inst.test[0].action[2].assert_fhir.message, "Last-Modified Present"
        )
        ...
        self.assertEqual(
            inst.test[0].action[3].assert_fhir.message, "Response is Patient"
        )
        ...
        self.assertEqual(
            inst.test[0].action[4].assert_fhir.message, "Response validates"
        )
        ...
        self.assertEqual(
            inst.test[0].action[6].assert_fhir.message, "Patient.name.given 'Peter'"
        )
        ...
        self.assertEqual(
            inst.test[0].action[9].assert_fhir.message, "Patient expected values."
        )
