...
class DocumentReferenceTests(unittest.TestCase):
    ...
    def implDocumentReference1(self, inst):
        ...
        self.assertEqual(
            inst.content[0].attachment.creation.datetime,
            FHIRDateTime("2005-12-24T09:35:00+11:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.content[0].format.display, "History and Physical Specification"
        )
        self.assertEqual(
            inst.content[0].format.system, "urn:oid:1.3.6.1.4.1.19376.1.2.3"
        )
        ...
        self.assertEqual(
            inst.context.period.end.datetime,
            FHIRDateTime("2004-12-23T08:01:00+11:00").datetime,
        )
        self.assertEqual(inst.context.period.end.as_json(), "2004-12-23T08:01:00+11:00")
        self.assertEqual(
            inst.context.period.start.datetime,
            FHIRDateTime("2004-12-23T08:00:00+11:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.date.datetime, FHIRInstant("2005-12-24T09:43:41+11:00").datetime
        )
