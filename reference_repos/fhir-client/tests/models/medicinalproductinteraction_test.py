...
class MedicinalProductInteractionTests(unittest.TestCase):
    ...
    def implMedicinalProductInteraction1(self, inst):
        ...
        self.assertEqual(
            inst.interactant[0].itemCodeableConcept.coding[0].code, "ketoconazole"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.interactant[1].itemCodeableConcept.coding[0].code, "itraconazole"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.type.coding[0].system, "http://ema.europa.eu/example/interactionsType"
        )
