...
class MolecularSequenceTests(unittest.TestCase):
    ...
    def implMolecularSequence3(self, inst):
        ...
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].code, "NC_000002.12"
        )
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].system,
            "http://www.ncbi.nlm.nih.gov/nuccore",
    ...
    def implMolecularSequence7(self, inst):
        ...
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].code, "NT_007592.15"
        )
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].system,
            "http://www.ncbi.nlm.nih.gov/nuccore",
    ...
    def implMolecularSequence9(self, inst):
        ...
        self.assertEqual(
            inst.quality[0].method.coding[0].code, "job-ByxYPx809jFVy21KJG74Jg3Y"
        )
        self.assertEqual(
            inst.quality[0].method.coding[0].system, "https://precision.fda.gov/jobs/"
        )
        ...
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].code, "NC_000001.11"
        )
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].system,
            "http://www.ncbi.nlm.nih.gov/nuccore",
    ...
    def implMolecularSequence10(self, inst):
        ...
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].code, "NC_000009.11"
        )
        self.assertEqual(
            inst.referenceSeq.referenceSeqId.coding[0].system,
            "http://www.ncbi.nlm.nih.gov/nuccore",
