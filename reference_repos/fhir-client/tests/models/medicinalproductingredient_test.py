...
class MedicinalProductIngredientTests(unittest.TestCase):
    ...
    def implMedicinalProductIngredient1(self, inst):
        ...
        self.assertEqual(
            inst.role.coding[0].system, "http://ema.europa.eu/example/ingredientRole"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.substance.code.coding[0].system,
            "http://ema.europa.eu/example/substance",
        )
        self.assertEqual(
            inst.substance.strength[0].presentation.denominator.unit, "{tablet}"
        )
