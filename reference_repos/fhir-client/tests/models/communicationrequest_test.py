...
class CommunicationRequestTests(unittest.TestCase):
    ...
    def implCommunicationRequest2(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2016-06-10T11:01:10-08:00").datetime
        )
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://www.jurisdiction.com/insurer/123456"
        )
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2016-06-10T11:01:10-08:00").datetime,
        )
