...
class SlotTests(unittest.TestCase):
    ...
    def implSlot3(self, inst):
        ...
        self.assertEqual(
            inst.end.datetime, FHIRInstant("2013-12-25T09:45:00Z").datetime
        )
        ...
        self.assertEqual(inst.serviceCategory[0].coding[0].display, "General Practice")
        self.assertEqual(
            inst.start.datetime, FHIRInstant("2013-12-25T09:30:00Z").datetime
        )
    ...
    def implSlot4(self, inst):
        self.assertEqual(inst.comment, "Dr Careful is out of the office")
        self.assertEqual(
            inst.end.datetime, FHIRInstant("2013-12-25T10:00:00Z").datetime
        )
        ...
        self.assertEqual(inst.serviceCategory[0].coding[0].display, "General Practice")
        self.assertEqual(
            inst.start.datetime, FHIRInstant("2013-12-25T09:45:00Z").datetime
        )
