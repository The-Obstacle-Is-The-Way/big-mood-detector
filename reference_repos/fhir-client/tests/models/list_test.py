...
class ListTests(unittest.TestCase):
    ...
    def implList4(self, inst):
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2016-07-14T11:54:05+10:00").datetime
        )
    ...
    def implList5(self, inst):
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2018-02-21T12:17:00+11:00").datetime
        )
    ...
    def implList6(self, inst):
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2012-11-25T22:17:00+11:00").datetime
        )
    ...
    def implList7(self, inst):
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2012-11-26T07:30:23+11:00").datetime
        )
    ...
    def implList8(self, inst):
        ...
        self.assertEqual(inst.code.text, "Medication Review")
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2013-11-20T23:10:23+11:00").datetime
        )
    ...
    def implList10(self, inst):
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2015-07-14T23:10:23+11:00").datetime
        )
