...
class DiagnosticReportTests(unittest.TestCase):
    ...
    def implDiagnosticReport1(self, inst):
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2016-10-15T12:34:56+11:00").datetime,
        )
        self.assertEqual(inst.effectiveDateTime.as_json(), "2016-10-15T12:34:56+11:00")
        self.assertEqual(inst.id, "example-pgx")
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2016-10-20T14:00:05+11:00").datetime
        )
        ...
        self.assertEqual(
            inst.presentedForm[0].creation.datetime,
            FHIRDateTime("2016-10-20T20:00:00+11:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.presentedForm[0].hash, "571ef9c5655840f324e679072ed62b1b95eef8a0"
        )
    ...
    def implDiagnosticReport2(self, inst):
        ...
        self.assertEqual(
            inst.effectiveDateTime.datetime,
            FHIRDateTime("2013-02-11T10:33:33+11:00").datetime,
        )
        self.assertEqual(inst.effectiveDateTime.as_json(), "2013-02-11T10:33:33+11:00")
        self.assertEqual(inst.id, "pap")
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2013-02-13T11:45:33+11:00").datetime
        )
    ...
    def implDiagnosticReport3(self, inst):
        ...
        self.assertEqual(
            inst.conclusionCode[0].coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.effectiveDateTime.datetime,
            FHIRDateTime("2012-12-01T12:00:00+01:00").datetime,
        )
        self.assertEqual(inst.effectiveDateTime.as_json(), "2012-12-01T12:00:00+01:00")
        self.assertEqual(inst.id, "f201")
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2012-12-01T12:00:00+01:00").datetime
        )
    ...
    def implDiagnosticReport5(self, inst):
        ...
        self.assertEqual(
            inst.effectiveDateTime.datetime, FHIRDateTime("2017-03-02").datetime
        )
        ...
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2017-03-15T08:13:08Z").datetime
        )
    ...
    def implDiagnosticReport6(self, inst):
        ...
        self.assertEqual(
            inst.effectiveDateTime.datetime, FHIRDateTime("2008-06-17").datetime
        )
        self.assertEqual(inst.effectiveDateTime.as_json(), "2008-06-17")
        self.assertEqual(inst.id, "102")
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2008-06-18T09:23:00+10:00").datetime
        )
