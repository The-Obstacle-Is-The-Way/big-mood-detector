...
class ScheduleTests(unittest.TestCase):
    ...
    def implSchedule1(self, inst):
        ...
        self.assertEqual(
            inst.planningHorizon.end.datetime,
            FHIRDateTime("2017-12-25T09:30:00Z").datetime,
        )
        self.assertEqual(inst.planningHorizon.end.as_json(), "2017-12-25T09:30:00Z")
        self.assertEqual(
            inst.planningHorizon.start.datetime,
            FHIRDateTime("2017-12-25T09:15:00Z").datetime,
        )
        ...
        self.assertEqual(
            inst.serviceCategory[0].coding[0].display, "Specialist Surgical"
        )
    ...
    def implSchedule2(self, inst):
        ...
        self.assertEqual(
            inst.planningHorizon.end.datetime,
            FHIRDateTime("2013-12-25T09:30:00Z").datetime,
        )
        self.assertEqual(inst.planningHorizon.end.as_json(), "2013-12-25T09:30:00Z")
        self.assertEqual(
            inst.planningHorizon.start.datetime,
            FHIRDateTime("2013-12-25T09:15:00Z").datetime,
        )
