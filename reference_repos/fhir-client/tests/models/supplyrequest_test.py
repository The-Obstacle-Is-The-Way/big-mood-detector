...
class SupplyRequestTests(unittest.TestCase):
    ...
    def implSupplyRequest1(self, inst):
        ...
        self.assertEqual(
            inst.itemCodeableConcept.coding[0].display, "Blood collect tubes blue cap"
        )
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2016-12-31").datetime
        )
        ...
        self.assertEqual(
            inst.reasonCode[0].coding[0].display, "Refill due to low stock"
        )
