...
class ObservationTests(unittest.TestCase):
    ...
    def implObservation1(self, inst):
        ...
        self.assertEqual(
            inst.effectiveDateTime.datetime, FHIRDateTime("1999-07-02").datetime
        )
        self.assertEqual(inst.effectiveDateTime.as_json(), "1999-07-02")
        self.assertEqual(inst.id, "body-temperature")
        self.assertEqual(
            inst.meta.profile[0], "http://hl7.org/fhir/StructureDefinition/vitalsigns"
        )
    ...
    def implObservation2(self, inst):
        ...
        self.assertEqual(
            ...
            " Blood type and Indirect antibody screen panel - Blood",
        )
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        self.assertEqual(inst.code.text, "Blood Group Panel")
        self.assertEqual(
            inst.effectiveDateTime.datetime,
            FHIRDateTime("2018-03-11T16:07:54+00:00").datetime,
        )
    ...
    def implObservation3(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Base excess in Blood by calculation"
        )
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        self.assertEqual(
            inst.effectivePeriod.end.datetime,
            FHIRDateTime("2013-04-05T10:30:10+01:00").datetime,
        )
        self.assertEqual(
            inst.effectivePeriod.end.as_json(), "2013-04-05T10:30:10+01:00"
        )
        self.assertEqual(
            inst.effectivePeriod.start.datetime,
            FHIRDateTime("2013-04-02T10:30:10+01:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2013-04-03T15:30:10+01:00").datetime
        )
    ...
    def implObservation5(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[1].display, "Second hand cigarette smoke (substance)"
        )
        ...
        self.assertEqual(
            inst.effectiveDateTime.datetime,
            FHIRDateTime("2016-05-18T22:33:22Z").datetime,
        )
        ...
        self.assertEqual(
            inst.valueCodeableConcept.coding[0].display, "Yes (qualifier value)"
        )
        self.assertEqual(
    ...
    def implObservation6(self, inst):
        ...
        self.assertEqual(
            inst.component[0].valueQuantity.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.component[1].dataAbsentReason.coding[0].code, "not-performed"
        )
        self.assertEqual(
            inst.component[1].dataAbsentReason.coding[0].display, "Not Performed"
        )
        self.assertEqual(
            inst.component[1].dataAbsentReason.coding[0].system,
            "http://terminology.hl7.org/CodeSystem/data-absent-reason",
        )
        self.assertEqual(
            inst.effectiveDateTime.datetime, FHIRDateTime("2012-09-17").datetime
        )
    ...
    def implObservation8(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Bicarbonate [Moles/?volume] in Serum"
        )
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(
            inst.identifier[0].system, "https://intranet.aumc.nl/labvalues"
        )
        ...
        self.assertEqual(
            inst.interpretation[0].coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(inst.interpretation[0].coding[1].code, "N")
        self.assertEqual(
            inst.interpretation[0].coding[1].system,
            "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation",
        )
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2013-04-04T14:34:00+01:00").datetime
        )
        ...
        self.assertEqual(
            inst.referenceRange[0].type.coding[0].system,
    ...
    def implObservation9(self, inst):
        ...
        self.assertEqual(
            inst.extension[0].valueCodeableConcept.coding[0].display, "CYP2C9"
        )
        self.assertEqual(
    ...
    def implObservation10(self, inst):
        ...
        self.assertEqual(
            inst.extension[0].valueCodeableConcept.coding[0].display, "TPMT"
        )
        self.assertEqual(
            inst.extension[0].valueCodeableConcept.coding[0].system,
            "http://www.genenames.org",
        ...
        self.assertEqual(
            inst.valueCodeableConcept.coding[0].system, "http://pharmakb.org"
        )
