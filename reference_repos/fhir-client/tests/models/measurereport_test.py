...
class MeasureReportTests(unittest.TestCase):
    ...
    def implMeasureReport1(self, inst):
        ...
        self.assertEqual(
            inst.group[0].stratifier[0].code[0].text, "stratifier-ages-up-to-9"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.group[0].stratifier[1].code[0].text, "stratifier-ages-10-plus"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.identifier[0].value, "measurereport-cms146-cat1-example-2017-03-13"
        )
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2014-01-01").datetime
        )
    ...
    def implMeasureReport2(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].value, "measurereport-cms146-cat2-example-2017-03-13"
        )
        self.assertEqual(inst.measure, "Measure/CMS146")
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
    ...
    def implMeasureReport3(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].value, "measurereport-cms146-cat3-example-2017-03-13"
        )
        self.assertEqual(inst.measure, "Measure/CMS146")
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
