...
class EncounterTests(unittest.TestCase):
    ...
    def implEncounter1(self, inst):
        ...
        self.assertEqual(
            inst.reasonCode[0].coding[0].display, "Heart valve replacement"
        )
    ...
    def implEncounter3(self, inst):
        ...
        self.assertEqual(
            inst.reasonCode[0].coding[0].display, "Retropharyngeal abscess"
        )
        self.assertEqual(inst.reasonCode[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.status, "finished")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implEncounter4(self, inst):
        ...
        self.assertEqual(
            inst.classHistory[0].period.end.datetime,
            FHIRDateTime("2017-02-01T09:27:00+10:00").datetime,
        )
        self.assertEqual(
            inst.classHistory[0].period.end.as_json(), "2017-02-01T09:27:00+10:00"
        )
        self.assertEqual(
            inst.classHistory[0].period.start.datetime,
            FHIRDateTime("2017-02-01T07:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.classHistory[1].period.start.datetime,
            FHIRDateTime("2017-02-01T09:27:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[0].period.end.datetime,
            FHIRDateTime("2017-02-01T08:45:00+10:00").datetime,
        )
        self.assertEqual(
            inst.location[0].period.end.as_json(), "2017-02-01T08:45:00+10:00"
        )
        self.assertEqual(
            inst.location[0].period.start.datetime,
            FHIRDateTime("2017-02-01T07:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[1].period.end.datetime,
            FHIRDateTime("2017-02-01T09:27:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[1].period.start.datetime,
            FHIRDateTime("2017-02-01T08:45:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[2].period.end.datetime,
            FHIRDateTime("2017-02-01T12:15:00+10:00").datetime,
        )
        self.assertEqual(
            inst.location[2].period.end.as_json(), "2017-02-01T12:15:00+10:00"
        )
        self.assertEqual(
            inst.location[2].period.start.datetime,
            FHIRDateTime("2017-02-01T09:27:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[3].period.end.datetime,
            FHIRDateTime("2017-02-01T12:45:00+10:00").datetime,
        )
        self.assertEqual(
            inst.location[3].period.end.as_json(), "2017-02-01T12:45:00+10:00"
        )
        self.assertEqual(
            inst.location[3].period.start.datetime,
            FHIRDateTime("2017-02-01T12:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[4].period.start.datetime,
            FHIRDateTime("2017-02-01T12:45:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[0].period.end.datetime,
            FHIRDateTime("2017-02-01T07:35:00+10:00").datetime,
        )
        self.assertEqual(
            inst.statusHistory[0].period.end.as_json(), "2017-02-01T07:35:00+10:00"
        )
        self.assertEqual(
            inst.statusHistory[0].period.start.datetime,
            FHIRDateTime("2017-02-01T07:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[1].period.end.datetime,
            FHIRDateTime("2017-02-01T08:45:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[1].period.start.datetime,
            FHIRDateTime("2017-02-01T07:35:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[2].period.end.datetime,
            FHIRDateTime("2017-02-01T12:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[2].period.start.datetime,
            FHIRDateTime("2017-02-01T08:45:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[3].period.end.datetime,
            FHIRDateTime("2017-02-01T12:45:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[3].period.start.datetime,
            FHIRDateTime("2017-02-01T12:15:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[4].period.start.datetime,
            FHIRDateTime("2017-02-01T12:45:00+10:00").datetime,
        )
        self.assertEqual(
    ...
    def implEncounter5(self, inst):
        ...
        self.assertEqual(
            inst.location[0].period.end.datetime,
            FHIRDateTime("2015-01-17T16:30:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.location[0].period.start.datetime,
            FHIRDateTime("2015-01-17T16:00:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.participant[0].period.end.datetime,
            FHIRDateTime("2015-01-17T16:30:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.participant[0].period.start.datetime,
            FHIRDateTime("2015-01-17T16:00:00+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.period.end.datetime, FHIRDateTime("2015-01-17T16:30:00+10:00").datetime
        )
    ...
    def implEncounter7(self, inst):
        ...
        self.assertEqual(
            inst.hospitalization.specialArrangement[0].coding[0].code, "wheel"
        )
        self.assertEqual(
            inst.hospitalization.specialArrangement[0].coding[0].display, "Wheelchair"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.statusHistory[0].period.start.datetime,
            FHIRDateTime("2013-03-08").datetime,
        )
    ...
    def implEncounter10(self, inst):
        ...
        self.assertEqual(inst.reasonCode[0].coding[0].code, "34068001")
        self.assertEqual(
            inst.reasonCode[0].coding[0].display, "Partial lobectomy of lung"
        )
        self.assertEqual(inst.reasonCode[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.status, "finished")
        self.assertEqual(inst.text.status, "generated")
