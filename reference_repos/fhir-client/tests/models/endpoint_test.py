...
class EndpointTests(unittest.TestCase):
    ...
    def implEndpoint1(self, inst):
        self.assertEqual(
            inst.address, "http://fhir3.healthintersections.com.au/open/CarePlan"
        )
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://example.org/enpoint-identifier"
        )
        ...
        self.assertEqual(
            inst.payloadType[0].coding[0].system, "http://hl7.org/fhir/resource-types"
        )
        self.assertEqual(
    ...
    def implEndpoint2(self, inst):
        self.assertEqual(
            inst.address, "https://pacs.hospital.org/IHEInvokeImageDisplay"
        )
    ...
    def implEndpoint4(self, inst):
        ...
        self.assertEqual(
            inst.payloadType[0].coding[0].code,
            "urn:hl7-org:sdwg:ccda-structuredBody:1.1",
        )
        self.assertEqual(
            inst.payloadType[0].coding[0].system, "urn:oid:1.3.6.1.4.1.19376.1.2.3"
        )
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.status, "generated")
