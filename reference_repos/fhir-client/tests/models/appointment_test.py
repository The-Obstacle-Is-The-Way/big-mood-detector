...
class AppointmentTests(unittest.TestCase):
    ...
    def implAppointment2(self, inst):
        ...
        self.assertEqual(
            inst.end.datetime, FHIRInstant("2013-12-10T11:00:00Z").datetime
        )
        ...
        self.assertEqual(inst.specialty[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(
            inst.start.datetime, FHIRInstant("2013-12-10T09:00:00Z").datetime
        )
    ...
    def implAppointment3(self, inst):
        ...
        self.assertEqual(
            inst.requestedPeriod[0].end.datetime, FHIRDateTime("2016-06-09").datetime
        )
        self.assertEqual(inst.requestedPeriod[0].end.as_json(), "2016-06-09")
        self.assertEqual(
            inst.requestedPeriod[0].start.datetime, FHIRDateTime("2016-06-02").datetime
        )
