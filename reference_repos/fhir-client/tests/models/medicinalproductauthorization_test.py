...
class MedicinalProductAuthorizationTests(unittest.TestCase):
    ...
    def implMedicinalProductAuthorization1(self, inst):
        ...
        self.assertEqual(
            inst.country[0].coding[0].system, "http://ema.europa.eu/example/country"
        )
        self.assertEqual(
            inst.dataExclusivityPeriod.end.datetime, FHIRDateTime("2020-08-15").datetime
        )
        self.assertEqual(inst.dataExclusivityPeriod.end.as_json(), "2020-08-15")
        self.assertEqual(
            inst.dataExclusivityPeriod.start.datetime,
            FHIRDateTime("2010-08-15").datetime,
        )
        self.assertEqual(inst.dataExclusivityPeriod.start.as_json(), "2010-08-15")
        self.assertEqual(
            inst.dateOfFirstAuthorization.datetime, FHIRDateTime("2010-08-15").datetime
        )
        ...
        self.assertEqual(
            inst.internationalBirthDate.datetime, FHIRDateTime("2010-08-15").datetime
        )
        self.assertEqual(inst.internationalBirthDate.as_json(), "2010-08-15")
        self.assertEqual(
            inst.jurisdictionalAuthorization[0].country.coding[0].code, "NO"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.jurisdictionalAuthorization[0].identifier[0].value, "123-456-789"
        )
        self.assertEqual(
            inst.jurisdictionalAuthorization[1].country.coding[0].code, "NO"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.jurisdictionalAuthorization[1].identifier[0].value, "123-456-123"
        )
        ...
        self.assertEqual(
            inst.procedure.application[0].dateDateTime.datetime,
            FHIRDateTime("2015-08-01").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.procedure.datePeriod.end.datetime, FHIRDateTime("2015-08-21").datetime
        )
        self.assertEqual(inst.procedure.datePeriod.end.as_json(), "2015-08-21")
        self.assertEqual(
            inst.procedure.datePeriod.start.datetime,
            FHIRDateTime("2015-08-02").datetime,
        )
        ...
        self.assertEqual(
            inst.validityPeriod.end.datetime, FHIRDateTime("2020-05-20").datetime
        )
        self.assertEqual(inst.validityPeriod.end.as_json(), "2020-05-20")
        self.assertEqual(
            inst.validityPeriod.start.datetime, FHIRDateTime("2015-08-16").datetime
        )
