...
class ValueSetTests(unittest.TestCase):
    ...
    def implValueSet1(self, inst):
        ...
        self.assertEqual(
            inst.compose.include[0].extension[0].url,
        ...
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[0].url, "display"
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[0].valueString,
            "(Most common)",
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[1].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[1].valueCode, "login"
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[2].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].extension[2].valueCode, "conflict"
        )
        self.assertEqual(
            inst.compose.include[0].extension[1].url,
        ...
        self.assertEqual(
            inst.compose.include[0].extension[2].extension[0].valueCode, "processing"
        )
        self.assertEqual(
            inst.compose.include[0].extension[2].extension[1].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[2].extension[1].valueCode, "duplicate"
        )
        self.assertEqual(
            inst.compose.include[0].extension[2].extension[2].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[2].extension[2].valueCode, "not-found"
        )
        self.assertEqual(
            inst.compose.include[0].extension[2].url,
            "http://hl7.org/fhir/StructureDefinition/valueset-expand-group",
        )
        self.assertEqual(inst.compose.include[0].extension[3].extension[0].url, "code")
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[0].valueCode, "invalid"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[1].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[1].valueCode, "structure"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[2].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[2].valueCode, "required"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[3].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].extension[3].valueCode, "value"
        )
        self.assertEqual(
            inst.compose.include[0].extension[3].url,
            "http://hl7.org/fhir/StructureDefinition/valueset-expand-group",
        )
        self.assertEqual(inst.compose.include[0].extension[4].extension[0].url, "code")
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[0].valueCode, "transient"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[1].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[1].valueCode, "lock"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[2].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[2].valueCode, "exception"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[3].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].extension[3].valueCode, "throttled"
        )
        self.assertEqual(
            inst.compose.include[0].extension[4].url,
            "http://hl7.org/fhir/StructureDefinition/valueset-expand-group",
        )
        self.assertEqual(inst.compose.include[0].extension[5].extension[0].url, "code")
        self.assertEqual(
            inst.compose.include[0].extension[5].extension[0].valueCode, "security"
        )
        self.assertEqual(
            inst.compose.include[0].extension[5].extension[1].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[5].extension[1].valueCode, "login"
        )
        self.assertEqual(
            inst.compose.include[0].extension[5].extension[2].url, "member"
        )
        self.assertEqual(
            inst.compose.include[0].extension[5].extension[2].valueCode, "unknown"
        )
        self.assertEqual(
            inst.compose.include[0].extension[5].url,
            "http://hl7.org/fhir/StructureDefinition/valueset-expand-group",
        )
        ...
        self.assertEqual(
            inst.expansion.contains[0].contains[0].display, "Login Required"
        )
        self.assertEqual(
            inst.expansion.contains[0].contains[0].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[0].contains[1].code, "conflict")
        self.assertEqual(
            inst.expansion.contains[0].contains[1].display, "Edit Version Conflict"
        )
        self.assertEqual(
            inst.expansion.contains[0].contains[1].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[1].contains[0].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[1].contains[1].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[1].display, "Processing Failure")
        self.assertEqual(
            inst.expansion.contains[1].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[2].contains[0].display, "Structural Issue"
        )
        self.assertEqual(
            inst.expansion.contains[2].contains[0].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[2].contains[1].code, "required")
        self.assertEqual(
            inst.expansion.contains[2].contains[1].display, "Required element missing"
        )
        self.assertEqual(
            inst.expansion.contains[2].contains[1].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[2].contains[2].code, "value")
        self.assertEqual(
            inst.expansion.contains[2].contains[2].display, "Element value invalid"
        )
        self.assertEqual(
            inst.expansion.contains[2].contains[2].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[2].display, "Invalid Content")
        self.assertEqual(
            inst.expansion.contains[2].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[3].contains[0].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[3].contains[1].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[3].contains[2].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[3].display, "Transient Issue")
        self.assertEqual(
            inst.expansion.contains[3].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[4].contains[0].display, "Login Required"
        )
        self.assertEqual(
            inst.expansion.contains[4].contains[0].system, "http://hl7.org/fhir/hacked"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[4].contains[1].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(inst.expansion.contains[4].display, "Security Problem")
        self.assertEqual(
            inst.expansion.contains[4].system, "http://hl7.org/fhir/hacked"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.expansion.timestamp.datetime,
            FHIRDateTime("2018-07-20T23:14:07+10:00").datetime,
        )
        self.assertEqual(
            inst.expansion.timestamp.as_json(), "2018-07-20T23:14:07+10:00"
        )
    ...
    def implValueSet2(self, inst):
        ...
        self.assertEqual(
            inst.expansion.timestamp.datetime,
            FHIRDateTime("2015-06-22T13:56:07Z").datetime,
        )
    ...
    def implValueSet3(self, inst):
        ...
        self.assertEqual(inst.contact[0].telecom[0].value, "http://hl7.org/fhir")
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2019-11-01T09:29:23+11:00").datetime
        )
        ...
        self.assertEqual(
            inst.identifier[0].value, "urn:oid:2.16.840.1.113883.4.642.3.316"
        )
        self.assertTrue(inst.immutable)
        self.assertEqual(
            inst.meta.lastUpdated.datetime,
            FHIRInstant("2019-11-01T09:29:23.356+11:00").datetime,
        )
        self.assertEqual(
    ...
    def implValueSet4(self, inst):
        self.assertEqual(
            inst.compose.include[0].valueSet[0],
        ...
        self.assertEqual(
            inst.expansion.contains[0].system,
        ...
        self.assertEqual(
            inst.expansion.contains[1].system,
            "http://terminology.hl7.org/CodeSystem/v2-0136",
        )
        ...
        self.assertEqual(
            inst.expansion.contains[2].system,
            "http://terminology.hl7.org/CodeSystem/data-absent-reason",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.expansion.timestamp.datetime,
            FHIRDateTime("2015-07-14T10:00:00Z").datetime,
        )
    ...
    def implValueSet5(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://acme.com/identifiers/valuesets"
        )
        ...
        self.assertEqual(
            inst.useContext[0].valueQuantity.system, "http://unitsofmeasure.org"
        )
    ...
    def implValueSet6(self, inst):
        ...
        self.assertEqual(
            inst.compose.include[0].system, "http://hl7.org/fhir/CodeSystem/example"
        )
        self.assertEqual(inst.contact[0].name, "FHIR project team")
        self.assertEqual(inst.contact[0].telecom[0].system, "url")
        self.assertEqual(inst.contact[0].telecom[0].value, "http://hl7.org/fhir")
    ...
    def implValueSet7(self, inst):
        ...
        self.assertEqual(
            inst.description, "HL7 v3 ActMood Predicate codes, including inactive codes"
        )
        ...
        self.assertEqual(
            inst.expansion.contains[1].contains[0].system,
            "http://terminology.hl7.org/CodeSystem/v3-ActMood",
        )
        ...
        self.assertEqual(
            inst.expansion.contains[1].contains[1].system,
            "http://terminology.hl7.org/CodeSystem/v3-ActMood",
        )
        ...
        self.assertEqual(
            inst.expansion.identifier, "urn:uuid:46c00b3f-003a-4f31-9d4b-ea2de58b2a99"
        )
        self.assertEqual(
            inst.expansion.timestamp.datetime,
            FHIRDateTime("2017-02-26T10:00:00Z").datetime,
        )
    ...
    def implValueSet8(self, inst):
        ...
        self.assertEqual(inst.identifier[0].system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier[0].value, "urn:oid:2.16.840.1.113883.4.642.3.858"
        )
        self.assertTrue(inst.immutable)
        self.assertEqual(
            inst.meta.lastUpdated.datetime,
        ...
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/ValueSet/examplescenario-actor-type"
        )
        self.assertEqual(inst.version, "4.0.1")
