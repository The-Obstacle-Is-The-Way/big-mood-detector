...
class StructureDefinitionTests(unittest.TestCase):
    ...
    def implStructureDefinition1(self, inst):
        ...
        self.assertEqual(
            inst.baseDefinition, "http://hl7.org/fhir/StructureDefinition/Composition"
        )
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2018-11-05T17:57:00+11:00").datetime
        )
        ...
        self.assertEqual(
            inst.differential.element[1].slicing.description,
            "Slice by .section.code when using this library of sections",
        )
        self.assertEqual(
            inst.differential.element[1].slicing.discriminator[0].path, "code"
        )
        self.assertEqual(
            inst.differential.element[1].slicing.discriminator[0].type, "pattern"
        )
        ...
        self.assertEqual(
            inst.differential.element[2].id, "Composition.section:procedure"
        )
        ...
        self.assertEqual(
            inst.differential.element[3].fixedString, "Procedures Performed"
        )
        self.assertEqual(
            inst.differential.element[3].id, "Composition.section:procedure.title"
        )
        ...
        self.assertEqual(
            inst.differential.element[4].id, "Composition.section:procedure.code"
        )
        ...
        self.assertEqual(
            inst.differential.element[4].patternCodeableConcept.coding[0].code,
            "29554-3",
        )
        self.assertEqual(
            inst.differential.element[4].patternCodeableConcept.coding[0].display,
            "Procedure Narrative",
        )
        self.assertEqual(
            inst.differential.element[4].patternCodeableConcept.coding[0].system,
            "http://loinc.org",
        )
        self.assertEqual(
            inst.differential.element[5].id, "Composition.section:medications"
        )
        ...
        self.assertEqual(
            inst.differential.element[6].fixedString, "Medications Administered"
        )
        self.assertEqual(
            inst.differential.element[6].id, "Composition.section:medications.title"
        )
        ...
        self.assertEqual(
            inst.differential.element[7].id, "Composition.section:medications.code"
        )
        ...
        self.assertEqual(
            inst.differential.element[7].patternCodeableConcept.coding[0].code,
            "29549-3",
        )
        self.assertEqual(
            inst.differential.element[7].patternCodeableConcept.coding[0].display,
            "Medication administered Narrative",
        )
        self.assertEqual(
            inst.differential.element[7].patternCodeableConcept.coding[0].system,
            "http://loinc.org",
        )
        ...
        self.assertEqual(
            inst.differential.element[9].fixedString, "Discharge Treatment Plan"
        )
        self.assertEqual(
            inst.differential.element[9].id, "Composition.section:plan.title"
        )
        ...
        self.assertEqual(
            inst.title, "Document Section Library (For testing section templates)"
        )
        self.assertEqual(inst.type, "Composition")
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/StructureDefinition/example-section-library"
        )
    ...
    def implStructureDefinition2(self, inst):
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2018-11-05T17:47:00+11:00").datetime
        )
        ...
        self.assertEqual(inst.differential.element[1].path, "Composition.section")
        self.assertEqual(
            inst.differential.element[1].slicing.description, "Slice by .section.code"
        )
        self.assertEqual(
            inst.differential.element[1].slicing.discriminator[0].path, "code"
        )
        ...
        self.assertEqual(
            inst.differential.element[2].type[0].profile[0],
            "http://hl7.org/fhir/StructureDefinition/document-section-library",
        )
        self.assertEqual(
            inst.differential.element[3].id, "Composition.section:medications"
        )
        self.assertEqual(inst.differential.element[3].min, 1)
        ...
        self.assertEqual(
            inst.differential.element[3].type[0].profile[0],
            "http://hl7.org/fhir/StructureDefinition/document-section-library",
        )
        ...
        self.assertEqual(
            inst.differential.element[4].type[0].profile[0],
            "http://hl7.org/fhir/StructureDefinition/document-section-library",
        )
        self.assertFalse(inst.experimental)
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.title, "Document Structure (For testing section templates)"
        )
        self.assertEqual(inst.type, "Composition")
        self.assertEqual(
