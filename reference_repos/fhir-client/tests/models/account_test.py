...
class AccountTests(unittest.TestCase):
    ...
    def implAccount1(self, inst):
        ...
        self.assertEqual(
            inst.guarantor[0].period.start.datetime, FHIRDateTime("2016-01-01").datetime
        )
        ...
        self.assertEqual(
            inst.servicePeriod.end.datetime, FHIRDateTime("2016-06-30").datetime
        )
        self.assertEqual(inst.servicePeriod.end.as_json(), "2016-06-30")
        self.assertEqual(
            inst.servicePeriod.start.datetime, FHIRDateTime("2016-01-01").datetime
        )
