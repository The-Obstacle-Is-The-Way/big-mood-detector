...
class TaskTests(unittest.TestCase):
    ...
    def implTask1(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2016-10-31T08:45:05+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.executionPeriod.start.datetime,
            FHIRDateTime("2016-10-31T08:45:05+10:00").datetime,
        )
        self.assertEqual(
            inst.executionPeriod.start.as_json(), "2016-10-31T08:45:05+10:00"
        )
        self.assertEqual(
            inst.groupIdentifier.system, "http:/goodhealth.org/accession/identifiers"
        )
        ...
        self.assertEqual(
            inst.lastModified.datetime,
            FHIRDateTime("2016-10-31T09:45:05+10:00").datetime,
        )
        ...
        self.assertEqual(
            inst.restriction.period.end.datetime,
            FHIRDateTime("2016-11-01T09:45:05+10:00").datetime,
        )
        self.assertEqual(
    ...
    def implTask2(self, inst):
        ...
        self.assertEqual(inst.code.text, "Specimen Collection")
        self.assertEqual(
            inst.executionPeriod.end.datetime,
            FHIRDateTime("2016-10-31T14:45:05+10:00").datetime,
        )
        self.assertEqual(
    ...
    def implTask3(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2016-03-10T22:39:32-04:00").datetime
        )
        ...
        self.assertEqual(
            inst.lastModified.datetime,
            FHIRDateTime("2016-03-10T22:39:32-04:00").datetime,
        )
    ...
    def implTask4(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2018-10-04T08:25:05+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.identifier[1].system, "http://nationalinsurers.com/identifiers/12345"
        )
        ...
        self.assertEqual(
            inst.lastModified.datetime,
            FHIRDateTime("2018-10-04T08:25:05+10:00").datetime,
        )
    ...
    def implTask6(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2018-10-12T08:25:05+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.input[1].valuePeriod.end.datetime, FHIRDateTime("2018-10-12").datetime
        )
        self.assertEqual(inst.input[1].valuePeriod.end.as_json(), "2018-10-12")
        self.assertEqual(
            inst.input[1].valuePeriod.start.datetime,
            FHIRDateTime("2018-10-01").datetime,
        )
        self.assertEqual(inst.input[1].valuePeriod.start.as_json(), "2018-10-01")
        self.assertEqual(inst.intent, "order")
        self.assertEqual(
            inst.lastModified.datetime,
            FHIRDateTime("2018-10-12T08:25:05+10:00").datetime,
        )
    ...
    def implTask7(self, inst):
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2016-10-31T08:25:05+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.executionPeriod.end.datetime,
            FHIRDateTime("2016-10-31T18:45:05+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.executionPeriod.start.datetime,
            FHIRDateTime("2016-10-31T08:25:05+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.restriction.period.end.datetime,
            FHIRDateTime("2016-11-02T09:45:05+10:00").datetime,
        )
        self.assertEqual(
    ...
    def implTask8(self, inst):
        ...
        self.assertEqual(inst.authoredOn.as_json(), "2016-10-31T08:25:05+10:00")
        self.assertEqual(
            inst.businessStatus.text, "specimen received, test in progress"
        )
        self.assertEqual(inst.code.text, "Lipid Panel")
        self.assertEqual(
            inst.description,
        ...
        self.assertEqual(
            inst.lastModified.datetime,
            FHIRDateTime("2016-10-31T16:45:05+10:00").datetime,
        )
