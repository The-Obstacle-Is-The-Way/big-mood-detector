...
class BundleTests(unittest.TestCase):
    ...
    def implBundle1(self, inst):
        self.assertEqual(
            inst.entry[0].fullUrl, "http://hl7.org/fhir/PractitionerRole/f003-0"
        )
        self.assertEqual(inst.entry[0].resource.id, "f003-0")
        self.assertEqual(
            inst.entry[1].fullUrl, "http://hl7.org/fhir/PractitionerRole/example-0"
        )
        self.assertEqual(inst.entry[1].resource.id, "example-0")
        self.assertEqual(
            inst.entry[2].fullUrl, "http://hl7.org/fhir/PractitionerRole/example-1"
        )
        self.assertEqual(inst.entry[2].resource.id, "example-1")
        self.assertEqual(
            inst.entry[3].fullUrl, "http://hl7.org/fhir/PractitionerRole/example-2"
        )
        self.assertEqual(inst.entry[3].resource.id, "example-2")
        self.assertEqual(
            inst.entry[4].fullUrl, "http://hl7.org/fhir/PractitionerRole/f007-0"
        )
        self.assertEqual(inst.entry[4].resource.id, "f007-0")
        self.assertEqual(
            inst.entry[5].fullUrl, "http://hl7.org/fhir/PractitionerRole/f004-0"
        )
        self.assertEqual(inst.entry[5].resource.id, "f004-0")
        self.assertEqual(
            inst.entry[6].fullUrl, "http://hl7.org/fhir/PractitionerRole/xcda1-0"
        )
        self.assertEqual(inst.entry[6].resource.id, "xcda1-0")
        self.assertEqual(
            inst.entry[7].fullUrl, "http://hl7.org/fhir/PractitionerRole/f202-0"
        )
        self.assertEqual(inst.entry[7].resource.id, "f202-0")
        self.assertEqual(
            inst.entry[8].fullUrl, "http://hl7.org/fhir/PractitionerRole/f201-0"
        )
        self.assertEqual(inst.entry[8].resource.id, "f201-0")
        self.assertEqual(
            inst.entry[9].fullUrl, "http://hl7.org/fhir/PractitionerRole/f203-0"
        )
    ...
    def implBundle2(self, inst):
        ...
        self.assertEqual(
            inst.entry[0].resource.meta.lastUpdated.datetime,
            FHIRInstant("2013-07-01T13:11:33Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[1].resource.meta.lastUpdated.datetime,
            FHIRInstant("2013-07-01T13:11:33Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[2].resource.meta.lastUpdated.datetime,
            FHIRInstant("2013-07-01T13:11:33Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[3].resource.meta.lastUpdated.datetime,
            FHIRInstant("2013-07-01T13:11:33Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[4].resource.meta.lastUpdated.datetime,
            FHIRInstant("2013-07-01T13:11:33Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.meta.lastUpdated.datetime, FHIRInstant("2013-07-01T13:11:33Z").datetime
        )
    ...
    def implBundle3(self, inst):
        self.assertEqual(
            inst.entry[0].fullUrl, "https://example.com/base/DiagnosticReport/f001"
        )
        self.assertEqual(inst.entry[0].resource.id, "f001")
        self.assertEqual(
            inst.entry[1].fullUrl, "https://example.com/base/ServiceRequest/req"
        )
    ...
    def implBundle4(self, inst):
        self.assertEqual(
            inst.entry[0].fullUrl, "https://example.com/base/DiagnosticReport/f202"
        )
    ...
    def implBundle6(self, inst):
        self.assertEqual(
            inst.entry[0].fullUrl, "http://hl7.org/fhir/us/sdc/Questionnaire/54127-6"
        )
        self.assertEqual(inst.entry[0].request.method, "PUT")
        self.assertEqual(
            inst.entry[0].request.url,
            "http://hl7.org/fhir/us/sdc/Questionnaire/54127-6",
        )
        ...
        self.assertEqual(
            inst.entry[1].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL1-9"
        )
        self.assertEqual(inst.entry[1].request.method, "PUT")
        self.assertEqual(
            inst.entry[1].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL1-9"
        )
        ...
        self.assertEqual(
            inst.entry[2].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL623-0"
        )
        self.assertEqual(inst.entry[2].request.method, "PUT")
        self.assertEqual(
            inst.entry[2].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL623-0"
        )
        ...
        self.assertEqual(
            inst.entry[3].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL361-7"
        )
        self.assertEqual(inst.entry[3].request.method, "PUT")
        self.assertEqual(
            inst.entry[3].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL361-7"
        )
        ...
        self.assertEqual(
            inst.entry[4].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL629-7"
        )
        self.assertEqual(inst.entry[4].request.method, "PUT")
        self.assertEqual(
            inst.entry[4].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL629-7"
        )
        ...
        self.assertEqual(
            inst.entry[5].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL628-9"
        )
        self.assertEqual(inst.entry[5].request.method, "PUT")
        self.assertEqual(
            inst.entry[5].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL628-9"
        )
        ...
        self.assertEqual(
            inst.entry[6].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL626-3"
        )
        self.assertEqual(inst.entry[6].request.method, "PUT")
        self.assertEqual(
            inst.entry[6].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL626-3"
        )
        ...
        self.assertEqual(
            inst.entry[7].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL619-8"
        )
        self.assertEqual(inst.entry[7].request.method, "PUT")
        self.assertEqual(
            inst.entry[7].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL619-8"
        )
        ...
        self.assertEqual(
            inst.entry[8].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL621-4"
        )
        self.assertEqual(inst.entry[8].request.method, "PUT")
        self.assertEqual(
            inst.entry[8].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL621-4"
        )
        ...
        self.assertEqual(
            inst.entry[9].fullUrl, "http://hl7.org/fhir/us/sdc/ValueSet/LL624-8"
        )
        self.assertEqual(inst.entry[9].request.method, "PUT")
        self.assertEqual(
            inst.entry[9].request.url, "http://hl7.org/fhir/us/sdc/ValueSet/LL624-8"
        )
    ...
    def implBundle8(self, inst):
        self.assertEqual(
            inst.entry[0].fullUrl, "https://example.com/base/MedicationRequest/3123"
        )
        ...
        self.assertEqual(
            inst.meta.lastUpdated.datetime, FHIRInstant("2014-08-18T01:43:30Z").datetime
        )
    ...
    def implBundle9(self, inst):
        ...
        self.assertEqual(
            inst.meta.lastUpdated.datetime, FHIRInstant("2012-04-14T10:35:23Z").datetime
        )
    ...
    def implBundle10(self, inst):
        ...
        self.assertEqual(
            inst.entry[1].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[5].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[6].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[7].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[8].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.entry[9].resource.meta.lastUpdated.datetime,
            FHIRInstant("2012-05-29T23:45:32Z").datetime,
        )
        self.assertEqual(
