...
class PatientTests(unittest.TestCase):
    ...
    def implPatient5(self, inst):
        ...
        self.assertEqual(
            inst.extension[0].extension[0].valueCodeableConcept.coding[0].code,
            "canislf",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.extension[0].extension[1].valueCodeableConcept.coding[0].code,
            "58108001",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.extension[0].extension[1].valueCodeableConcept.coding[1].code, "gret"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.extension[0].extension[2].valueCodeableConcept.coding[0].code,
            "neutered",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2010-05-31").datetime,
        )
    ...
    def implPatient7(self, inst):
        ...
        self.assertEqual(
            inst.address[0].period.start.datetime, FHIRDateTime("1974-12-25").datetime
        )
        ...
        self.assertEqual(
            inst.address[0].text, "534 Erewhon St PeasantVille, Rainbow, Vic  3999"
        )
        ...
        self.assertEqual(
            inst.contact[0].address.period.start.datetime,
            FHIRDateTime("1974-12-25").datetime,
        )
        ...
        self.assertEqual(
            inst.contact[0].period.start.datetime, FHIRDateTime("2012").datetime
        )
        ...
        self.assertEqual(
            inst.name[2].period.end.datetime, FHIRDateTime("2002").datetime
        )
        ...
        self.assertEqual(
            inst.telecom[3].period.end.datetime, FHIRDateTime("2014").datetime
        )
    ...
    def implPatient10(self, inst):
        ...
        self.assertEqual(
            inst.deceasedDateTime.datetime,
            FHIRDateTime("2015-02-14T13:42:00+10:00").datetime,
        )
