...
class ServiceRequestTests(unittest.TestCase):
    ...
    def implServiceRequest2(self, inst):
        ...
        self.assertEqual(
            inst.category[0].coding[0].display, "Diagnostic procedure (procedure)"
        )
        ...
        self.assertEqual(
            inst.text.div, '<div xmlns="http://www.w3.org/1999/xhtml">To be added</div>'
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implServiceRequest3(self, inst):
        ...
        self.assertEqual(
            inst.category[0].coding[0].display, "Patient referral to specialist"
        )
        self.assertEqual(inst.category[0].coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.note[0].text,
            "In the past 2 years Beverly has had 6 instances of rt-sided Otitis media. She is     falling behind her peers at school, and displaying some learning difficulties.",
        )
        self.assertEqual(
            inst.note[0].time.datetime, FHIRDateTime("2014-02-14").datetime
        )
        ...
        self.assertEqual(
            inst.performerType.coding[0].system,
    ...
    def implServiceRequest5(self, inst):
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime,
            FHIRDateTime("2015-08-27T09:33:27+07:00").datetime,
        )
    ...
    def implServiceRequest6(self, inst):
        ...
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2017-02-01T17:23:07Z").datetime
        )
        self.assertEqual(inst.authoredOn.as_json(), "2017-02-01T17:23:07Z")
        self.assertEqual(inst.code.coding[0].code, "34431008")
        self.assertEqual(
            inst.code.coding[0].display, "Physiotherapy of chest (regime/therapy) "
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
    ...
    def implServiceRequest10(self, inst):
        ...
        self.assertEqual(
            inst.category[0].coding[0].display, "Patient education (procedure)"
        )
        self.assertEqual(inst.category[0].coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2014-08-16").datetime
        )
