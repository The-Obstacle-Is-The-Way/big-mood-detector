...
class ConceptMapTests(unittest.TestCase):
    ...
    def implConceptMap1(self, inst):
        ...
        self.assertEqual(
            inst.group[0].element[1].target[0].comment,
            "HL7 term is a historical term. mapped to Pus",
        )
        self.assertEqual(inst.group[0].element[1].target[0].equivalence, "equivalent")
        self.assertEqual(
            inst.group[0].element[1].target[0].product[0].property, "TypeModifier"
        )
        self.assertEqual(
            inst.group[0].element[1].target[0].product[0].system,
            "http://snomed.info/sct",
        )
        self.assertEqual(
            inst.group[0].element[1].target[0].product[0].value, "47002008"
        )
        ...
        self.assertEqual(
            inst.group[0].element[3].target[0].product[0].property, "TypeModifier"
        )
        self.assertEqual(
            inst.group[0].element[3].target[0].product[0].system,
            "http://snomed.info/sct",
        )
        ...
        self.assertEqual(
            inst.group[0].element[4].target[0].product[0].property,
            "http://snomed.info/id/246380002",
        )
        self.assertEqual(
            inst.group[0].element[4].target[0].product[0].system,
            "http://snomed.info/sct",
        )
        self.assertEqual(
            inst.group[0].element[4].target[0].product[0].value, "81723002"
        )
        ...
        self.assertEqual(
            inst.group[0].element[8].target[0].product[0].property,
            "http://snomed.info/id/246380002",
        )
        self.assertEqual(
            inst.group[0].element[8].target[0].product[0].system,
            "http://snomed.info/sct",
        )
        self.assertEqual(
            inst.group[0].element[8].target[0].product[0].value, "14766002"
        )
        ...
        self.assertEqual(
            inst.group[0].source, "http://terminology.hl7.org/CodeSystem/v2-0487"
        )
        ...
        self.assertEqual(
            inst.sourceCanonical, "http://terminology.hl7.org/ValueSet/v2-0487"
        )
    ...
    def implConceptMap2(self, inst):
        ...
        self.assertEqual(
            inst.group[0].element[0].target[0].dependsOn[0].display, "Something Coded"
        )
        self.assertEqual(
            inst.group[0].element[0].target[0].dependsOn[0].property,
            "http://example.org/fhir/property-value/example",
        )
        self.assertEqual(
            inst.group[0].element[0].target[0].dependsOn[0].system,
            "http://example.org/fhir/example3",
        )
        self.assertEqual(
            inst.group[0].element[0].target[0].dependsOn[0].value, "some-code"
        )
        self.assertEqual(
            inst.group[0].element[0].target[0].display, "Some Example Code"
        )
        self.assertEqual(inst.group[0].element[0].target[0].equivalence, "equivalent")
        ...
        self.assertEqual(
            inst.group[0].unmapped.url, "http://example.org/fhir/ConceptMap/map2"
        )
    ...
    def implConceptMap3(self, inst):
        ...
        self.assertEqual(
            inst.group[0].element[2].target[0].display, "temporary address"
        )
        self.assertEqual(inst.group[0].element[2].target[0].equivalence, "equivalent")
        ...
        self.assertEqual(
            inst.group[0].target, "http://terminology.hl7.org/CodeSystem/v3-AddressUse"
        )
        ...
        self.assertEqual(inst.publisher, "HL7, Inc")
        self.assertEqual(
            inst.purpose, "To help implementers map from HL7 v3/CDA to FHIR"
        )
        self.assertEqual(inst.sourceUri, "http://hl7.org/fhir/ValueSet/address-use")
        self.assertEqual(inst.status, "draft")
        self.assertEqual(
            inst.targetUri, "http://terminology.hl7.org/ValueSet/v3-AddressUse"
        )
        self.assertEqual(inst.text.status, "generated")
