...
class CapabilityStatementTests(unittest.TestCase):
    ...
    def implCapabilityStatement1(self, inst):
        ...
        self.assertEqual(
            inst.instantiates[0], "http://ihe.org/fhir/CapabilityStatement/pixm-client"
        )
        ...
        self.assertEqual(
            inst.rest[0].resource[0].searchParam[1].name, "general-practitioner"
        )
        ...
        self.assertEqual(
            inst.software.releaseDate.datetime, FHIRDateTime("2012-01-04").datetime
        )
