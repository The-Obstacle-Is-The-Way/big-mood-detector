...
class LibraryTests(unittest.TestCase):
    ...
    def implLibrary1(self, inst):
        ...
        self.assertEqual(
            inst.dataRequirement[1].codeFilter[0].code[0].code, "diagnosis"
        )
        self.assertEqual(inst.dataRequirement[1].codeFilter[0].path, "category")
        self.assertEqual(
            inst.dataRequirement[1].codeFilter[1].code[0].code, "confirmed"
        )
        ...
        self.assertEqual(
            inst.dataRequirement[2].codeFilter[0].code[0].code, "diagnosis"
        )
        self.assertEqual(inst.dataRequirement[2].codeFilter[0].path, "category")
        self.assertEqual(
            inst.dataRequirement[2].codeFilter[1].code[0].code, "confirmed"
        )
        ...
        self.assertEqual(
            inst.dataRequirement[3].codeFilter[1].code[0].code, "ambulatory"
        )
        ...
        self.assertEqual(
            inst.dataRequirement[7].codeFilter[0].code[0].code, "completed"
        )
        ...
        self.assertEqual(
            inst.relatedArtifact[0].resource, "Library/library-quick-model-definition"
        )
    ...
    def implLibrary2(self, inst):
        ...
        self.assertEqual(
            inst.relatedArtifact[0].resource, "Library/fhir-model-definition"
        )
        self.assertEqual(inst.relatedArtifact[0].type, "depends-on")
        self.assertEqual(
            inst.relatedArtifact[1].resource, "Library/library-fhir-helpers"
        )
    ...
    def implLibrary3(self, inst):
        ...
        self.assertEqual(
            inst.relatedArtifact[3].resource, "Library/zika-virus-intervention-logic"
        )
        self.assertEqual(inst.relatedArtifact[3].type, "composed-of")
        self.assertEqual(
            inst.relatedArtifact[4].resource, "PlanDefinition/zika-virus-intervention"
        )
        self.assertEqual(inst.relatedArtifact[4].type, "composed-of")
        self.assertEqual(
            inst.relatedArtifact[5].resource,
