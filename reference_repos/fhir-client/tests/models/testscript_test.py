...
class TestScriptTests(unittest.TestCase):
    ...
    def implTestScript1(self, inst):
        ...
        self.assertEqual(
            inst.jurisdiction[0].coding[0].display, "United States of America (the)"
        )
        self.assertEqual(inst.jurisdiction[0].coding[0].system, "urn:iso:std:iso:3166")
        self.assertEqual(
            inst.metadata.capability[0].capabilities, "CapabilityStatement/example"
        )
        self.assertEqual(
            inst.metadata.capability[0].description, "Patient Search Operation"
        )
        self.assertEqual(
            inst.metadata.capability[0].link[0], "http://hl7.org/fhir/http.html#search"
        )
        ...
        self.assertEqual(
            inst.test[0].action[0].operation.responseId, "PatientCreateResponse"
        )
        self.assertEqual(
            inst.test[0].action[0].operation.sourceId, "fixture-patient-create"
        )
        ...
        self.assertEqual(
            inst.test[1].action[4].assert_fhir.validateProfileId, "bundle-profile"
        )
        ...
        self.assertEqual(
            inst.test[1].action[5].assert_fhir.path, "fhir:Bundle/fhir:type/@value"
        )
        ...
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/TestScript/testscript-example-search"
        )
    ...
    def implTestScript2(self, inst):
        ...
        self.assertEqual(
            inst.metadata.capability[0].link[0], "http://hl7.org/fhir/http.html#delete"
        )
        self.assertEqual(
            inst.metadata.capability[0].link[1], "http://hl7.org/fhir/http.html#read"
        )
        self.assertEqual(
            inst.metadata.capability[0].link[2], "http://hl7.org/fhir/http.html#update"
        )
        self.assertTrue(inst.metadata.capability[0].required)
        self.assertFalse(inst.metadata.capability[0].validated)
        self.assertEqual(
        ...
        self.assertEqual(
            inst.setup.action[2].operation.sourceId, "fixture-patient-create"
        )
        ...
        self.assertEqual(
            inst.setup.action[4].operation.targetId, "fixture-patient-create"
        )
        ...
        self.assertEqual(
            inst.teardown.action[0].operation.targetId, "fixture-patient-create"
        )
        ...
        self.assertEqual(inst.test[0].action[0].operation.resource, "Patient")
        self.assertEqual(
            inst.test[0].action[0].operation.responseId, "fixture-patient-read"
        )
        self.assertEqual(
            inst.test[0].action[0].operation.targetId, "fixture-patient-create"
        )
        ...
        self.assertEqual(
            inst.test[0].action[5].assert_fhir.sourceId, "fixture-patient-read"
        )
        ...
        self.assertEqual(
            inst.test[0].action[6].assert_fhir.sourceId, "fixture-patient-read"
        )
        ...
        self.assertEqual(
            inst.test[0].action[7].assert_fhir.compareToSourceId,
        ...
        self.assertEqual(
            inst.test[0].action[8].assert_fhir.compareToSourceId,
            "fixture-patient-create",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.test[0].action[8].assert_fhir.sourceId, "fixture-patient-read"
        )
        ...
        self.assertEqual(
            inst.test[0].action[9].assert_fhir.minimumId, "fixture-patient-minimum"
        )
        ...
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].code, "positive"
        )
        self.assertEqual(
    ...
    def implTestScript3(self, inst):
        ...
        self.assertEqual(inst.identifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier.value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7.9879"
        )
        self.assertEqual(inst.jurisdiction[0].coding[0].code, "US")
        self.assertEqual(
            inst.jurisdiction[0].coding[0].display, "United States of America (the)"
        ...
        self.assertEqual(
            inst.metadata.capability[0].description, "Patient Read Operation"
        )
        self.assertEqual(
            inst.metadata.capability[0].link[0], "http://hl7.org/fhir/http.html#read"
        )
        self.assertTrue(inst.metadata.capability[0].required)
        self.assertFalse(inst.metadata.capability[0].validated)
        self.assertEqual(
        ...
        self.assertTrue(inst.test[0].action[0].operation.encodeRequestUrl)
        self.assertEqual(
            inst.test[0].action[0].operation.params, "/${KnownPatientResourceId}"
        )
        self.assertEqual(inst.test[0].action[0].operation.resource, "Patient")
        self.assertEqual(inst.test[0].action[0].operation.type.code, "read")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.test[0].action[3].assert_fhir.headerField, "Last-Modified"
        )
        ...
        self.assertEqual(
            inst.test[0].action[5].assert_fhir.validateProfileId, "patient-profile"
        )
        self.assertFalse(inst.test[0].action[5].assert_fhir.warningOnly)
        self.assertEqual(
            inst.test[0].description, "Read a known Patient and validate response."
        )
        ...
        self.assertEqual(
            inst.test[2].action[0].operation.params, "/${NonExistsPatientResourceId}"
        )
        ...
        self.assertEqual(
            inst.test[3].action[0].operation.params, "/ID-may-not-contain-CAPITALS"
        )
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/TestScript/testscript-example-readtest"
        )
    ...
    def implTestScript4(self, inst):
        ...
        self.assertEqual(inst.identifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier.value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7.9878"
        )
        self.assertEqual(inst.jurisdiction[0].coding[0].code, "US")
        self.assertEqual(
            inst.jurisdiction[0].coding[0].display, "United States of America (the)"
        ...
        self.assertFalse(inst.metadata.capability[0].validated)
        self.assertEqual(
            inst.metadata.capability[1].capabilities, "CapabilityStatement/example"
        )
        self.assertEqual(
            inst.metadata.capability[1].description, "Patient Read Operation"
        )
        self.assertEqual(inst.metadata.capability[1].destination, 2)
        self.assertEqual(
            inst.metadata.capability[1].link[0], "http://hl7.org/fhir/http.html#read"
        )
        ...
        self.assertEqual(
            inst.test[0].action[0].operation.params, "/${Dest1PatientResourceId}"
        )
        self.assertEqual(
            inst.test[0].action[0].operation.requestId, "request-read-patient-01"
        )
        self.assertEqual(inst.test[0].action[0].operation.resource, "Patient")
        self.assertEqual(inst.test[0].action[0].operation.type.code, "read")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.test[1].action[0].operation.params, "/${Dest2PatientResourceId}"
        )
        self.assertEqual(
            inst.test[1].action[0].operation.requestHeader[0].field, "Accept-Charset"
        )
        self.assertEqual(
            inst.test[1].action[0].operation.requestHeader[0].value, "utf-8"
        )
        self.assertEqual(inst.test[1].action[0].operation.resource, "Patient")
        self.assertEqual(inst.test[1].action[0].operation.type.code, "read")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/TestScript/testscript-example-multisystem"
        )
        self.assertEqual(inst.variable[0].defaultValue, "example")
    ...
    def implTestScript5(self, inst):
        ...
        self.assertEqual(inst.identifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier.value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7.9882"
        )
        self.assertEqual(inst.jurisdiction[0].coding[0].code, "US")
        self.assertEqual(
            inst.jurisdiction[0].coding[0].display, "United States of America (the)"
        ...
        self.assertEqual(
            inst.metadata.capability[0].link[0], "http://hl7.org/fhir/http.html#update"
        )
        self.assertEqual(
            inst.metadata.capability[0].link[1], "http://hl7.org/fhir/http.html#delete"
        )
        self.assertTrue(inst.metadata.capability[0].required)
        self.assertFalse(inst.metadata.capability[0].validated)
        self.assertEqual(
        ...
        self.assertEqual(inst.publisher, "HL7")
        self.assertEqual(
            inst.purpose, "Patient (Conditional) Create, Update, Delete Operations"
        )
        self.assertEqual(inst.setup.action[0].operation.accept, "xml")
        self.assertEqual(
            inst.setup.action[0].operation.description,
        ...
        self.assertEqual(
            inst.test[0].action[0].operation.params, "/${createResourceId}"
        )
        self.assertEqual(inst.test[0].action[0].operation.resource, "Patient")
        self.assertEqual(
            inst.test[0].action[0].operation.sourceId, "fixture-patient-update"
        )
        ...
        self.assertTrue(inst.test[0].action[3].assert_fhir.warningOnly)
        self.assertEqual(
            inst.test[0].description, "Update a Patient and validate response."
        )
        self.assertEqual(inst.test[0].id, "01-UpdatePatient")
        self.assertEqual(inst.test[0].name, "Update Patient")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/TestScript/testscript-example-update"
        )
        self.assertEqual(inst.variable[0].name, "createResourceId")
        self.assertEqual(inst.variable[0].path, "Patient/id")
        self.assertEqual(inst.variable[0].sourceId, "fixture-patient-create")
    ...
    def implTestScript6(self, inst):
        ...
        self.assertEqual(inst.identifier.system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier.value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7.9877"
        )
        self.assertEqual(inst.jurisdiction[0].coding[0].code, "US")
        self.assertEqual(
            inst.jurisdiction[0].coding[0].display, "United States of America (the)"
        ...
        self.assertEqual(inst.setup.action[4].operation.resource, "Patient")
        self.assertEqual(
            inst.setup.action[4].operation.sourceId, "fixture-patient-update"
        )
        ...
        self.assertEqual(
            inst.test[0].action[3].assert_fhir.validateProfileId, "bundle-profile"
        )
        self.assertFalse(inst.test[0].action[3].assert_fhir.warningOnly)
        self.assertEqual(
            inst.test[0].action[4].assert_fhir.description,
        ...
        self.assertEqual(
            inst.test[0].action[4].assert_fhir.path, "fhir:Bundle/fhir:type/@value"
        )
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.url, "http://hl7.org/fhir/TestScript/testscript-example-history"
        )
        self.assertEqual(inst.variable[0].name, "createResourceId")
        self.assertEqual(inst.variable[0].path, "Patient/id")
        self.assertEqual(inst.variable[0].sourceId, "fixture-patient-create")
