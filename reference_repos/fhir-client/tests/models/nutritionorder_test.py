...
class NutritionOrderTests(unittest.TestCase):
    ...
    def implNutritionOrder1(self, inst):
        ...
        self.assertEqual(
            inst.oralDiet.schedule[0].repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2015-02-10").datetime,
        )
        self.assertEqual(
    ...
    def implNutritionOrder2(self, inst):
        ...
        self.assertEqual(
            inst.supplement[0].schedule[0].repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2015-02-10T15:00:00Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.supplement[0].type.coding[0].display,
    ...
    def implNutritionOrder8(self, inst):
        ...
        self.assertEqual(
            inst.enteralFormula.administration[
                0
            ].schedule.repeat.boundsPeriod.start.datetime,
            FHIRDateTime("2014-09-17T16:00:00Z").datetime,
        )
        self.assertEqual(
            inst.enteralFormula.administration[
                0
        ...
        self.assertEqual(
            inst.enteralFormula.administration[0].schedule.repeat.periodUnit, "h"
        )
        self.assertEqual(
            inst.enteralFormula.baseFormulaProductName, "Acme High Protein Formula"
        )
        self.assertEqual(
            inst.enteralFormula.baseFormulaType.coding[0].code, "442991000124104"
        )
        self.assertEqual(
    ...
    def implNutritionOrder9(self, inst):
        ...
        self.assertEqual(
            inst.enteralFormula.administration[0].rateQuantity.code, "mL/h"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.enteralFormula.administration[0].rateQuantity.unit, "ml/hr"
        )
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2014-09-17T07:00:00Z").datetime,
        )
        self.assertEqual(
            inst.enteralFormula.administration[
                0
        ...
        self.assertEqual(
            inst.enteralFormula.administration[1].rateQuantity.code, "mL/h"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.enteralFormula.administration[1].rateQuantity.unit, "ml/hr"
        )
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2014-09-17T11:00:00Z").datetime,
        )
        self.assertEqual(
            inst.enteralFormula.administration[
                1
        ...
        self.assertEqual(
            inst.enteralFormula.administration[2].rateQuantity.code, "mL/h"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.enteralFormula.administration[2].rateQuantity.unit, "ml/hr"
        )
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2014-09-17T15:00:00Z").datetime,
        )
        self.assertEqual(
            inst.enteralFormula.administration[
                2
        ...
        self.assertEqual(
            inst.enteralFormula.baseFormulaProductName, " Acme Diabetes Formula"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.enteralFormula.routeofAdministration.coding[0].code, "NGT"
        )
        self.assertEqual(
            inst.enteralFormula.routeofAdministration.coding[0].display,
