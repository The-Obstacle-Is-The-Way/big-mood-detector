...
class CoverageTests(unittest.TestCase):
    ...
    def implCoverage1(self, inst):
        ...
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2011-05-23").datetime
        )
    ...
    def implCoverage2(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://hospitalx.com/selfpayagreement"
        )
    ...
    def implCoverage3(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://ehic.com/insurer/123456789/member"
        )
    ...
    def implCoverage4(self, inst):
        ...
        self.assertEqual(
            inst.costToBeneficiary[0].exception[0].period.end.datetime,
            FHIRDateTime("2018-12-31").datetime,
        )
        self.assertEqual(
            inst.costToBeneficiary[0].exception[0].period.end.as_json(), "2018-12-31"
        )
        self.assertEqual(
            inst.costToBeneficiary[0].exception[0].period.start.datetime,
            FHIRDateTime("2018-01-01").datetime,
        )
        self.assertEqual(
            inst.costToBeneficiary[0].exception[0].period.start.as_json(), "2018-01-01"
        )
        self.assertEqual(
            inst.costToBeneficiary[0].exception[0].type.coding[0].code, "retired"
        )
        self.assertEqual(
        ...
        self.assertEqual(inst.period.end.as_json(), "2012-03-17")
        self.assertEqual(
            inst.period.start.datetime, FHIRDateTime("2011-03-17").datetime
        )
