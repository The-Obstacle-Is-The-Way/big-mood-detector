...
class ChargeItemDefinitionTests(unittest.TestCase):
    ...
    def implChargeItemDefinition1(self, inst):
        ...
        self.assertEqual(
            inst.applicability[1].description, "Applies only once per Encounter"
        )
        ...
        self.assertEqual(
            inst.code.coding[0].system, "http://fhir.de/CodingSystem/kbv/ebm"
        )
        self.assertEqual(
            inst.description,
        ...
        self.assertEqual(
            inst.effectivePeriod.end.datetime, FHIRDateTime("2018-06-30").datetime
        )
        self.assertEqual(inst.effectivePeriod.end.as_json(), "2018-06-30")
        self.assertEqual(
            inst.effectivePeriod.start.datetime, FHIRDateTime("2018-04-01").datetime
        )
        ...
        self.assertEqual(
            inst.propertyGroup[0].priceComponent[0].code.coding[0].code, "gesamt-euro"
        )
        self.assertEqual(
    ...
    def implChargeItemDefinition2(self, inst):
        ...
        self.assertEqual(inst.propertyGroup[0].priceComponent[0].amount.value, 67.44)
        self.assertEqual(
            inst.propertyGroup[0].priceComponent[0].code.coding[0].code, "VK"
        )
        self.assertEqual(
            inst.propertyGroup[0].priceComponent[0].code.coding[0].display,
            "Verkaufspreis (netto)",
        ...
        self.assertEqual(inst.propertyGroup[0].priceComponent[0].type, "base")
        self.assertEqual(
            inst.propertyGroup[1].applicability[0].description, "Gültigkeit Steuersatz"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.propertyGroup[1].applicability[0].language, "text/fhirpath"
        )
        self.assertEqual(
            inst.propertyGroup[1].priceComponent[0].code.coding[0].code, "MWST"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.propertyGroup[2].applicability[0].description, "Gültigkeit Steuersatz"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.propertyGroup[2].applicability[0].language, "text/fhirpath"
        )
        self.assertEqual(
            inst.propertyGroup[2].priceComponent[0].code.coding[0].code, "MWST"
        )
        self.assertEqual(
