...
class ImmunizationTests(unittest.TestCase):
    ...
    def implImmunization1(self, inst):
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2018-06-18").datetime
        )
        ...
        self.assertEqual(
            inst.protocolApplied[1].targetDisease[0].coding[0].code, "66071002"
        )
        self.assertEqual(
    ...
    def implImmunization2(self, inst):
        ...
        self.assertEqual(
            inst.education[0].presentationDate.datetime,
            FHIRDateTime("2013-01-10").datetime,
        )
        self.assertEqual(inst.education[0].presentationDate.as_json(), "2013-01-10")
        self.assertEqual(
            inst.education[0].publicationDate.datetime,
            FHIRDateTime("2012-07-02").datetime,
        )
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2015-01-15").datetime
        )
    ...
    def implImmunization3(self, inst):
        ...
        self.assertEqual(
            inst.occurrenceDateTime.datetime, FHIRDateTime("2013-01-10").datetime
        )
    ...
    def implImmunization4(self, inst):
        ...
        self.assertEqual(
            inst.note[0].text, "Notes on adminstration of a historical vaccine"
        )
