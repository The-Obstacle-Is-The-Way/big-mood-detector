...
class DetectedIssueTests(unittest.TestCase):
    ...
    def implDetectedIssue3(self, inst):
        ...
        self.assertEqual(
            inst.identifiedDateTime.datetime, FHIRDateTime("2013-05-08").datetime
        )
    ...
    def implDetectedIssue4(self, inst):
        ...
        self.assertEqual(
            inst.identifiedDateTime.datetime, FHIRDateTime("2014-01-05").datetime
        )
        ...
        self.assertEqual(
            inst.mitigation[0].date.datetime, FHIRDateTime("2014-01-05").datetime
        )
