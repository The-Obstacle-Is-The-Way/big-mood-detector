...
class ClinicalImpressionTests(unittest.TestCase):
    ...
    def implClinicalImpression1(self, inst):
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2014-12-06T22:33:00+11:00").datetime
        )
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2014-12-06T22:33:00+11:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            FHIRDateTime("2014-12-06T20:00:00+11:00").datetime,
        )
        self.assertEqual(
