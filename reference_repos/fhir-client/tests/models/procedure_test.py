...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure2(self, inst):
        ...
        self.assertEqual(
            inst.category.coding[0].display, "Diagnostic procedure (procedure)"
        )
        ...
        self.assertEqual(
            inst.complication[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.performedDateTime.datetime, FHIRDateTime("2014-02-03").datetime
        )
        ...
        self.assertEqual(
            inst.usedCode[0].coding[0].display, "Needle, device (physical object)"
        )
    ...
    def implProcedure4(self, inst):
        ...
        self.assertEqual(
            inst.performedPeriod.end.datetime,
            FHIRDateTime("2013-03-24T10:30:10+01:00").datetime,
        )
        self.assertEqual(
            inst.performedPeriod.end.as_json(), "2013-03-24T10:30:10+01:00"
        )
        self.assertEqual(
            inst.performedPeriod.start.datetime,
            FHIRDateTime("2013-03-24T09:30:10+01:00").datetime,
        )
        self.assertEqual(
    ...
    def implProcedure5(self, inst):
        ...
        self.assertEqual(
            inst.category.coding[0].display, "Patient education (procedure)"
        )
        self.assertEqual(inst.category.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.performedDateTime.datetime, FHIRDateTime("2014-08-16").datetime
        )
    ...
    def implProcedure7(self, inst):
        ...
        self.assertEqual(
            inst.category.coding[0].display, "Obstetric procedure (procedure)"
        )
        self.assertEqual(inst.category.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.performedDateTime.datetime, FHIRDateTime("2012-06-02").datetime
        )
    ...
    def implProcedure8(self, inst):
        ...
        self.assertEqual(
            inst.performedPeriod.end.datetime, FHIRDateTime("2011-06-27").datetime
        )
        self.assertEqual(inst.performedPeriod.end.as_json(), "2011-06-27")
        self.assertEqual(
            inst.performedPeriod.start.datetime, FHIRDateTime("2011-06-26").datetime
        )
    ...
    def implProcedure9(self, inst):
        ...
        self.assertEqual(
            inst.performedPeriod.end.datetime,
            FHIRDateTime("2013-03-22T10:30:10+01:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.performedPeriod.start.datetime,
            FHIRDateTime("2013-03-22T09:30:10+01:00").datetime,
        )
        self.assertEqual(
    ...
    def implProcedure10(self, inst):
        ...
        self.assertEqual(
            inst.performedDateTime.datetime, FHIRDateTime("2015-04-05").datetime
        )
