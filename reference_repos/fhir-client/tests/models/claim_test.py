...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(
            inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code, "654456"
        )
    ...
    def implClaim2(self, inst):
        ...
        self.assertEqual(
            inst.item[0].detail[0].productOrService.coding[0].code, "drugcost"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].productOrService.coding[0].code, "markup"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[2].productOrService.coding[0].code, "dispensefee"
        )
        self.assertEqual(
        ...
        self.assertEqual(inst.status, "active")
        self.assertEqual(
            inst.supportingInfo[0].category.coding[0].code, "pharmacyrefill"
        )
    ...
    def implClaim3(self, inst):
        ...
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        self.assertEqual(
            inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code, "654321"
        )
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        ...
        self.assertEqual(
            inst.item[0].detail[0].productOrService.coding[0].code, "frame"
        )
        self.assertEqual(
            inst.item[0].detail[0].productOrService.coding[0].system,
        ...
        self.assertEqual(
            inst.item[0].detail[0].revenue.coding[0].display, "Vision Clinic"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].revenue.coding[0].display, "Vision Clinic"
        )
        self.assertEqual(
        ...
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].category.coding[0].code, "F6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].modifier[0].coding[0].code, "rooh"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].productOrService.coding[0].code, "lens"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].programCode[0].coding[0].code, "none"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].revenue.coding[0].code, "0010"
        )
        self.assertEqual(
            inst.item[0].detail[1].subDetail[0].revenue.coding[0].display,
            "Vision Clinic",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].category.coding[0].code, "F6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].modifier[0].coding[0].code, "rooh"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].revenue.coding[0].code, "0010"
        )
        self.assertEqual(
            inst.item[0].detail[1].subDetail[1].revenue.coding[0].display,
            "Vision Clinic",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].category.coding[0].code, "F6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].modifier[0].coding[0].code, "rooh"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].revenue.coding[0].code, "0010"
        )
        self.assertEqual(
            inst.item[0].detail[1].subDetail[2].revenue.coding[0].display,
            "Vision Clinic",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[2].revenue.coding[0].display, "Vision Clinic"
        )
        self.assertEqual(
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(
            inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code, "123457"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[0].productOrService.coding[0].code, "ORTHOEXAM"
        )
        self.assertEqual(
            inst.item[0].detail[0].productOrService.coding[0].system,
        ...
        self.assertEqual(
            inst.item[0].detail[1].productOrService.coding[0].code, "ORTHODIAG"
        )
        self.assertEqual(
            inst.item[0].detail[1].productOrService.coding[0].system,
            "http://example.org/fhir/oralservicecodes",
        ...
        self.assertEqual(
            inst.item[0].detail[2].productOrService.coding[0].code, "ORTHOINITIAL"
        )
        self.assertEqual(
            inst.item[0].detail[2].productOrService.coding[0].system,
            "http://example.org/fhir/oralservicecodes",
        ...
        self.assertEqual(
            inst.item[0].detail[3].productOrService.coding[0].code, "ORTHOMONTHS"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].detail[4].productOrService.coding[0].code, "ORTHOPERIODIC"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].detail[0].productOrService.coding[0].code, "27211"
        )
        self.assertEqual(
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.created.as_json(), "2014-08-16")
        self.assertEqual(
            inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code, "123456"
        )
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        ...
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(
            inst.insurance[0].identifier.system, "http://happyvalley.com/claim"
        )
    ...
    def implClaim7(self, inst):
        ...
        self.assertEqual(inst.priority.coding[0].code, "normal")
        self.assertEqual(
            inst.procedure[0].date.datetime, FHIRDateTime("2014-08-16").datetime
        )
        self.assertEqual(inst.procedure[0].date.as_json(), "2014-08-16")
        self.assertEqual(
            inst.procedure[0].procedureCodeableConcept.coding[0].code, "SDI9901"
        )
        self.assertEqual(
