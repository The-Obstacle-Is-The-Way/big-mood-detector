...
class ConditionTests(unittest.TestCase):
    ...
    def implCondition1(self, inst):
        self.assertEqual(
            inst.abatementDateTime.datetime, FHIRDateTime("2013-03-20").datetime
        )
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2013-03-11").datetime
        )
        self.assertEqual(inst.onsetDateTime.as_json(), "2013-03-11")
        self.assertEqual(
            inst.recordedDate.datetime, FHIRDateTime("2013-03-11").datetime
        )
        ...
        self.assertEqual(
            inst.stage[0].summary.coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implCondition3(self, inst):
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2010-07-18").datetime
        )
    ...
    def implCondition4(self, inst):
        ...
        self.assertEqual(
            inst.evidence[0].code[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2011-05-05").datetime
        )
        self.assertEqual(inst.onsetDateTime.as_json(), "2011-05-05")
        self.assertEqual(
            inst.recordedDate.datetime, FHIRDateTime("2012-06-03").datetime
        )
        ...
        self.assertEqual(
            inst.stage[0].type.coding[0].display, "Clinical staging (qualifier value)"
        )
    ...
    def implCondition5(self, inst):
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2013-03-08").datetime
        )
    ...
    def implCondition6(self, inst):
        ...
        self.assertEqual(
            inst.bodySite[0].coding[0].display, "Left external ear structure"
        )
        self.assertEqual(inst.bodySite[0].coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2012-05-24").datetime
        )
    ...
    def implCondition7(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Family history of cancer of colon"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
    ...
    def implCondition8(self, inst):
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2012-02-27").datetime
        )
        self.assertEqual(inst.onsetDateTime.as_json(), "2012-02-27")
        self.assertEqual(
            inst.recordedDate.datetime, FHIRDateTime("2012-02-20").datetime
        )
    ...
    def implCondition9(self, inst):
        ...
        self.assertEqual(
            inst.recordedDate.datetime, FHIRDateTime("2013-04-04").datetime
        )
    ...
    def implCondition10(self, inst):
        ...
        self.assertEqual(
            inst.evidence[0].code[0].coding[0].display, "Cardiac chest pain"
        )
        self.assertEqual(
            inst.evidence[0].code[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.onsetDateTime.datetime, FHIRDateTime("2011-08-05").datetime
        )
        self.assertEqual(inst.onsetDateTime.as_json(), "2011-08-05")
        self.assertEqual(
            inst.recordedDate.datetime, FHIRDateTime("2011-10-05").datetime
        )
