...
class AllergyIntoleranceTests(unittest.TestCase):
    ...
    def implAllergyIntolerance1(self, inst):
        ...
        self.assertEqual(
            inst.reaction[0].exposureRoute.coding[0].display, "Subcutaneous route"
        )
        self.assertEqual(
            inst.reaction[0].exposureRoute.coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.reaction[0].onset.datetime, FHIRDateTime("2012-06-12").datetime
        )
        ...
        self.assertEqual(
            inst.recordedDate.datetime,
            FHIRDateTime("2014-10-09T14:58:00+11:00").datetime,
        )
