...
class CommunicationTests(unittest.TestCase):
    ...
    def implCommunication1(self, inst):
        ...
        self.assertEqual(
            inst.category[0].coding[0].system, "http://acme.org/messagetypes"
        )
        ...
        self.assertEqual(
            inst.received.datetime, FHIRDateTime("2014-12-12T18:01:11-08:00").datetime
        )
        self.assertEqual(inst.received.as_json(), "2014-12-12T18:01:11-08:00")
        self.assertEqual(
            inst.sent.datetime, FHIRDateTime("2014-12-12T18:01:10-08:00").datetime
        )
    ...
    def implCommunication2(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://www.providerco.com/communication"
        )
        ...
        self.assertEqual(
            inst.payload[0].contentAttachment.contentType, "application/pdf"
        )
        self.assertEqual(
            inst.payload[0].contentAttachment.creation.datetime,
            FHIRDateTime("2010-02-01T11:50:23-05:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.payload[0].contentAttachment.title, "accident notes 20100201.pdf"
        )
        self.assertEqual(
            inst.payload[1].contentAttachment.contentType, "application/pdf"
        )
        self.assertEqual(
            inst.payload[1].contentAttachment.creation.datetime,
            FHIRDateTime("2010-02-01T10:57:34+01:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.payload[1].contentAttachment.url, "http://example.org/docs/AB12345"
        )
        self.assertEqual(
            inst.sent.datetime, FHIRDateTime("2016-06-12T18:01:10-08:00").datetime
        )
