...
class SpecimenDefinitionTests(unittest.TestCase):
    ...
    def implSpecimenDefinition1(self, inst):
        ...
        self.assertEqual(
            inst.patientPreparation[1].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.typeTested[0].container.cap.coding[0].display, "yellow cap"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].container.material.coding[0].code, "61088005"
        )
        self.assertEqual(
            inst.typeTested[0].container.material.coding[0].display, "plastic"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].handling[0].temperatureRange.high.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].handling[0].temperatureRange.high.unit, "°C"
        )
        self.assertEqual(inst.typeTested[0].handling[0].temperatureRange.high.value, 25)
        self.assertEqual(
            inst.typeTested[0].handling[0].temperatureRange.low.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].handling[1].temperatureRange.high.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].handling[1].temperatureRange.high.unit, "°C"
        )
        self.assertEqual(inst.typeTested[0].handling[1].temperatureRange.high.value, 8)
        self.assertEqual(
            inst.typeTested[0].handling[1].temperatureRange.low.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[0].type.coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(inst.typeTested[1].container.cap.coding[0].code, "green")
        self.assertEqual(
            inst.typeTested[1].container.cap.coding[0].display, "green cap"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].container.material.coding[0].code, "32039001"
        )
        self.assertEqual(
            inst.typeTested[1].container.material.coding[0].display, "glass"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].handling[0].temperatureRange.high.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].handling[0].temperatureRange.high.unit, "°C"
        )
        self.assertEqual(inst.typeTested[1].handling[0].temperatureRange.high.value, 25)
        self.assertEqual(
            inst.typeTested[1].handling[0].temperatureRange.low.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].handling[1].temperatureRange.high.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].handling[1].temperatureRange.high.unit, "°C"
        )
        self.assertEqual(inst.typeTested[1].handling[1].temperatureRange.high.value, 8)
        self.assertEqual(
            inst.typeTested[1].handling[1].temperatureRange.low.code, "Cel"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].rejectionCriterion[0].coding[0].code, "insufficient"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].rejectionCriterion[1].coding[0].code, "hemolized"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.typeTested[1].type.coding[0].system, "http://snomed.info/sct"
        )
