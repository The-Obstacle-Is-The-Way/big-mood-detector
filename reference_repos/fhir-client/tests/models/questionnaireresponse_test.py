...
class QuestionnaireResponseTests(unittest.TestCase):
    ...
    def implQuestionnaireResponse1(self, inst):
        self.assertEqual(
            inst.authored.datetime, FHIRDateTime("2013-02-19T14:15:00-05:00").datetime
        )
        ...
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[0].answer[0].valueCoding.code,
            "1",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[0].linkId, "1.1.1.1"
        )
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[1].answer[0].valueCoding.code,
            "1",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[1].linkId, "1.1.1.2"
        )
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[2].answer[0].valueCoding.code,
            "0",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[0].item[0].answer[0].item[0].item[2].linkId, "1.1.1.3"
        )
    ...
    def implQuestionnaireResponse2(self, inst):
        self.assertEqual(
            inst.authored.datetime, FHIRDateTime("2013-06-18T00:00:00+01:00").datetime
        )
        self.assertEqual(inst.authored.as_json(), "2013-06-18T00:00:00+01:00")
        self.assertEqual(inst.id, "f201")
        self.assertEqual(
            inst.item[0].item[0].answer[0].valueString, "I am allergic to house dust"
        )
        self.assertEqual(inst.item[0].item[0].linkId, "1.1")
        ...
        self.assertEqual(
            inst.item[2].item[1].answer[0].valueString, "No, but I used to drink"
        )
    ...
    def implQuestionnaireResponse3(self, inst):
        ...
        self.assertEqual(
            inst.item[1].definition, "http://loinc.org/fhir/DataElement/54126-8"
        )
        self.assertEqual(
            inst.item[1].item[0].item[0].answer[0].valueString, "Annie Proband"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].item[0].item[1].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
            inst.item[1].item[0].item[1].answer[0].valueCoding.display, "Female"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].item[0].item[3].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[1].item[0].item[3].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[1].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[1].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[1].item[0].item[6].answer[0].item[0].item[0].linkId, "1.1.7.1.1"
        )
        self.assertEqual(
            inst.item[1].item[0].item[6].answer[0].item[0].item[0].text, "Units"
        )
        self.assertEqual(
            inst.item[1].item[0].item[6].answer[0].item[0].linkId, "1.1.7.1"
        )
        ...
        self.assertEqual(
            inst.item[1].item[0].item[7].answer[0].item[0].item[0].linkId, "1.1.8.1.1"
        )
        self.assertEqual(
            inst.item[1].item[0].item[7].answer[0].item[0].item[0].text, "Units"
        )
        self.assertEqual(
            inst.item[1].item[0].item[7].answer[0].item[0].linkId, "1.1.8.1"
        )
        ...
        self.assertEqual(
            inst.item[1].item[0].item[9].answer[0].valueCoding.code, "LA4457-3"
        )
        self.assertEqual(
            inst.item[1].item[0].item[9].answer[0].valueCoding.display, "White"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].definition, "http://loinc.org/fhir/DataElement/54114-4"
        )
        self.assertEqual(
            inst.item[2].item[0].item[0].answer[0].valueCoding.code, "LA10405-1"
        )
        self.assertEqual(
            inst.item[2].item[0].item[0].answer[0].valueCoding.display, "Daughter"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[0].item[2].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
            inst.item[2].item[0].item[2].answer[0].valueCoding.display, "Female"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[1].answer[0].valueString, "Brian"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[2].answer[0].valueCoding.code, "LA2-8"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[2].answer[0].valueCoding.display, "Male"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[1].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[1].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[1].item[1].item[0].text, "Disease or Condition"
        )
        self.assertEqual(
            inst.item[2].item[1].item[1].item[1].answer[0].valueCoding.code, "LA10397-0"
        )
        self.assertEqual(
            inst.item[2].item[1].item[1].item[1].answer[0].valueCoding.display, "30-39"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[1].answer[0].valueString, "Janet"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[2].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[2].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[2].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[2].item[1].item[0].text, "Disease or Condition"
        )
        self.assertEqual(
            inst.item[2].item[2].item[1].item[1].answer[0].valueCoding.code, "LA10397-0"
        )
        self.assertEqual(
            inst.item[2].item[2].item[1].item[1].answer[0].valueCoding.display, "30-39"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[1].answer[0].valueString, "Ian"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[2].answer[0].valueCoding.code, "LA2-8"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[2].answer[0].valueCoding.display, "Male"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[3].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[3].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[0].answer[0].valueCoding.display, "Niece"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[1].answer[0].valueString, "Helen"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[2].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[4].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[4].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[1].answer[0].valueString, "Donald"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[2].answer[0].valueCoding.code, "LA2-8"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[2].answer[0].valueCoding.display, "Male"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[5].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[5].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[1].answer[0].valueString, "Eric"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[2].answer[0].valueCoding.code, "LA2-8"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[2].answer[0].valueCoding.display, "Male"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[6].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[6].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[1].answer[0].valueString, "Fiona"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[2].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[3].answer[0].item[0].item[0].text, "Age"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.2"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[3].answer[0].valueCoding.code, "LA33-6"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[3].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[7].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[7].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[7].item[1].item[0].text, "Disease or Condition"
        )
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[1].answer[0].valueString, "Bob"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[2].answer[0].valueCoding.code, "LA2-8"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[2].answer[0].valueCoding.display, "Male"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.1"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[3].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[3].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[8].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[8].item[0].item[5].text, "Was this person adopted?"
        )
        ...
        self.assertEqual(
            inst.item[2].item[8].item[1].item[0].text, "Disease or Condition"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[0].text, "Relationship to you"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[1].answer[0].valueString, "Claire"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[2].answer[0].valueCoding.code, "LA3-6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[3].answer[0].item[0].linkId, "2.1.1.4.1"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[3].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[3].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[4].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[4].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[4].text, "Was this person born a twin?"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[5].answer[0].valueCoding.code, "LA32-8"
        )
        self.assertEqual(
            inst.item[2].item[9].item[0].item[5].answer[0].valueCoding.display, "No"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.item[2].item[9].item[0].item[5].text, "Was this person adopted?"
        )
    ...
    def implQuestionnaireResponse4(self, inst):
        self.assertEqual(
            inst.authored.datetime, FHIRDateTime("2014-12-11T04:44:16Z").datetime
        )
        ...
        self.assertEqual(
            inst.item[2].answer[0].valueCoding.display, "Eyes open spontaneously"
        )
        self.assertEqual(
    ...
    def implQuestionnaireResponse5(self, inst):
        self.assertEqual(
            inst.authored.datetime, FHIRDateTime("2013-02-19T14:15:00+10:00").datetime
        )
        self.assertEqual(inst.authored.as_json(), "2013-02-19T14:15:00+10:00")
        self.assertEqual(inst.id, "bb")
        self.assertEqual(
            inst.item[0].item[0].item[0].answer[0].valueString, "Cathy Jones"
        )
        ...
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].item[0].item[0].linkId,
            "vitaminKDose1",
        )
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].item[0].item[0].text, "1st dose"
        )
        self.assertEqual(
            inst.item[0]
            .item[1]
        ...
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].item[0].item[1].linkId,
            "vitaminKDose2",
        )
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].item[0].item[1].text, "2nd dose"
        )
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].item[0].linkId, "vitaminKgivenDoses"
        )
        self.assertEqual(
            inst.item[0].item[1].item[2].answer[0].valueCoding.code, "INJECTION"
        )
        ...
        self.assertEqual(
            inst.item[0].item[1].item[3].answer[0].item[0].linkId, "hepBgivenDate"
        )
        self.assertEqual(
            inst.item[0].item[1].item[3].answer[0].item[0].text, "Date given"
        )
        ...
        self.assertEqual(
            inst.item[0].item[1].item[4].text, "Abnormalities noted at birth"
        )
        ...
        self.assertEqual(
            inst.item[0].text, "Birth details - To be completed by health professional"
        )
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(
