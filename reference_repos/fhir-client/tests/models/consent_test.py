...
class ConsentTests(unittest.TestCase):
    ...
    def implConsent1(self, inst):
        ...
        self.assertEqual(
            inst.sourceAttachment.title, "The terms of the consent in lawyer speak."
        )
    ...
    def implConsent2(self, inst):
        ...
        self.assertEqual(
            inst.provision.period.end.datetime, FHIRDateTime("2016-01-01").datetime
        )
        self.assertEqual(inst.provision.period.end.as_json(), "2016-01-01")
        self.assertEqual(
            inst.provision.period.start.datetime, FHIRDateTime("1964-01-01").datetime
        )
    ...
    def implConsent3(self, inst):
        ...
        self.assertEqual(
            inst.dateTime.datetime, FHIRDateTime("2016-05-26T00:41:10-04:00").datetime
        )
        self.assertEqual(inst.dateTime.as_json(), "2016-05-26T00:41:10-04:00")
        self.assertEqual(inst.id, "consent-example-signature")
        self.assertEqual(
            inst.identifier[0].system, "urn:oid:2.16.840.1.113883.3.72.5.9.1"
        )
        self.assertEqual(
            inst.identifier[0].value, "494e0c7a-a69e-4fb4-9d02-6aae747790d7"
        )
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.period.end.datetime, FHIRDateTime("2016-10-10").datetime
        )
        self.assertEqual(inst.provision.period.end.as_json(), "2016-10-10")
        self.assertEqual(
            inst.provision.period.start.datetime, FHIRDateTime("2015-10-10").datetime
        )
        self.assertEqual(inst.provision.period.start.as_json(), "2015-10-10")
        self.assertEqual(
            inst.provision.provision[0].actor[0].role.coding[0].code, "AUT"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[0].class_fhir[0].code, "application/hl7-cda+xml"
        )
        self.assertEqual(
            inst.provision.provision[0].class_fhir[0].system, "urn:ietf:bcp:13"
        )
        self.assertEqual(inst.provision.provision[0].code[0].coding[0].code, "34133-9")
        self.assertEqual(
            inst.provision.provision[0].code[0].coding[0].system, "http://loinc.org"
        )
        self.assertEqual(inst.provision.provision[0].code[1].coding[0].code, "18842-5")
        self.assertEqual(
            inst.provision.provision[0].code[1].coding[0].system, "http://loinc.org"
        )
    ...
    def implConsent5(self, inst):
        ...
        self.assertEqual(inst.category[0].coding[0].system, "http://loinc.org")
        self.assertEqual(
            inst.dateTime.datetime, FHIRDateTime("2016-06-23T17:02:33+10:00").datetime
        )
        ...
        self.assertEqual(
            inst.provision.period.end.datetime,
            FHIRDateTime("2016-06-23T17:32:33+10:00").datetime,
        )
        self.assertEqual(
            inst.provision.period.end.as_json(), "2016-06-23T17:32:33+10:00"
        )
        self.assertEqual(
            inst.provision.period.start.datetime,
            FHIRDateTime("2016-06-23T17:02:33+10:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[0].class_fhir[0].code, "MedicationRequest"
        )
        self.assertEqual(
    ...
    def implConsent6(self, inst):
        ...
        self.assertEqual(
            inst.provision.provision[0].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
            inst.provision.provision[0].actor[0].role.coding[0].system,
            "http://terminology.hl7.org/CodeSystem/v3-ParticipationType",
        ...
        self.assertEqual(
            inst.provision.provision[1].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[2].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[3].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[4].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[5].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[6].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[7].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[8].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.provision.provision[9].actor[0].role.coding[0].code, "PRCP"
        )
        self.assertEqual(
    ...
    def implConsent7(self, inst):
        ...
        self.assertEqual(
            inst.provision.period.end.datetime, FHIRDateTime("2015-02-01").datetime
        )
        self.assertEqual(inst.provision.period.end.as_json(), "2015-02-01")
        self.assertEqual(
            inst.provision.period.start.datetime, FHIRDateTime("2015-01-01").datetime
        )
    ...
    def implConsent10(self, inst):
        ...
        self.assertEqual(
            inst.provision.provision[0].actor[0].role.coding[0].code, "CST"
        )
        self.assertEqual(
            inst.provision.provision[0].actor[0].role.coding[0].system,
            "http://terminology.hl7.org/CodeSystem/v3-ParticipationType",
        ...
        self.assertEqual(
            inst.provision.purpose[0].system,
            "http://terminology.hl7.org/CodeSystem/v3-ActReason",
        )
        self.assertEqual(inst.scope.coding[0].code, "patient-privacy")
        self.assertEqual(
