...
class MedicinalProductTests(unittest.TestCase):
    ...
    def implMedicinalProduct1(self, inst):
        ...
        self.assertEqual(
            inst.manufacturingBusinessOperation[0].effectiveDate.datetime,
            FHIRDateTime("2013-03-15").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.name[0].countryLanguage[0].jurisdiction.coding[0].code, "EU"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.name[0].productName, "Equilidem 2.5 mg film-coated tablets"
        )
        self.assertEqual(
