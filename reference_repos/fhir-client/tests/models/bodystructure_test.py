...
class BodyStructureTests(unittest.TestCase):
    ...
    def implBodyStructure1(self, inst):
        ...
        self.assertEqual(
            inst.locationQualifier[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.locationQualifier[1].coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implBodyStructure2(self, inst):
        ...
        self.assertEqual(
            inst.morphology.coding[0].display, "Mass (morphologic abnormality)"
        )
