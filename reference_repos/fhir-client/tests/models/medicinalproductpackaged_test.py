...
class MedicinalProductPackagedTests(unittest.TestCase):
    ...
    def implMedicinalProductPackaged1(self, inst):
        self.assertEqual(
            inst.batchIdentifier[0].outerPackaging.period.end.datetime,
            FHIRDateTime("2016-06-06").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.packageItem[0].packageItem[0].material[0].coding[0].code, "Paperboard"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.packageItem[0].packageItem[0].physicalCharacteristics.width.unit, "mm"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.packageItem[0].packageItem[0].shelfLifeStorage[0].period.unit, "a"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.packageItem[0].packageItem[0].type.coding[0].code, "Blister"
        )
        self.assertEqual(
