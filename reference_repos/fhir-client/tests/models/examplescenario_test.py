...
class ExampleScenarioTests(unittest.TestCase):
    ...
    def implExampleScenario1(self, inst):
        ...
        self.assertEqual(
            inst.actor[2].description, "The Medication Administration Order Placer"
        )
        ...
        self.assertEqual(
            inst.instance[9].containedInstance[0].resourceId, "iherx001.001"
        )
        self.assertEqual(
            inst.instance[9].containedInstance[1].resourceId, "iherx001.002"
        )
        self.assertEqual(
            inst.instance[9].containedInstance[2].resourceId, "iherx001.003"
        )
        self.assertEqual(
            inst.instance[9].containedInstance[3].resourceId, "iherx001.004"
        )
        self.assertEqual(
            inst.instance[9].containedInstance[4].resourceId, "iherx001.005"
        )
        self.assertEqual(
            inst.instance[9].containedInstance[5].resourceId, "iherx001.006"
        )
        self.assertEqual(
            inst.instance[9].description, "All the medication Requests for Day 1"
        )
        ...
        self.assertEqual(
            inst.process[0].step[0].operation.name, "1. Get today's schedule"
        )
        ...
        self.assertEqual(
            inst.process[0].step[1].process[0].step[0].operation.initiator, "MAP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.process[0].step[1].process[0].step[0].operation.number, "2"
        )
        self.assertEqual(
            inst.process[0].step[1].process[0].step[0].operation.receiver, "OP"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.process[0].step[1].process[0].title,
            "P1. Query Administration Requests",
        )
        ...
        self.assertEqual(
            inst.process[0].step[6].operation.name, "Ask if patient took meds"
        )
