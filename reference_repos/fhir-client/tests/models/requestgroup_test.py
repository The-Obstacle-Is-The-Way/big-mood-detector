...
class RequestGroupTests(unittest.TestCase):
    ...
    def implRequestGroup1(self, inst):
        ...
        self.assertEqual(
            inst.authoredOn.datetime, FHIRDateTime("2017-03-06T17:31:00Z").datetime
        )
    ...
    def implRequestGroup2(self, inst):
        self.assertEqual(
            inst.action[0].action[0].description, "Administer medication 1"
        )
        ...
        self.assertEqual(
            inst.action[0].action[1].description, "Administer medication 2"
        )
        ...
        self.assertEqual(
            inst.action[0].timingDateTime.datetime,
            FHIRDateTime("2017-03-06T19:00:00Z").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.groupIdentifier.system, "http://example.org/treatment-group"
        )
