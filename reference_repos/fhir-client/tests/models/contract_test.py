...
class ContractTests(unittest.TestCase):
    ...
    def implContract1(self, inst):
        ...
        self.assertEqual(
            inst.subType[0].coding[0].display, "Default Authorization with exceptions."
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.term[0].applies.start.datetime, FHIRDateTime("2015-11-18").datetime
        )
        self.assertEqual(inst.term[0].applies.start.as_json(), "2015-11-18")
        self.assertEqual(
            inst.term[0].identifier.system, "http://example.org/fhir/term-items"
        )
        self.assertEqual(inst.term[0].identifier.value, "3347689")
        self.assertEqual(
            inst.term[0].issued.datetime, FHIRDateTime("2015-11-01").datetime
        )
        ...
        self.assertEqual(
            inst.term[0].type.coding[0].code, "withhold-identified-object-and-related"
        )
        self.assertEqual(
    ...
    def implContract2(self, inst):
        ...
        self.assertEqual(
            inst.term[0].group[0].offer.text, "Withhold orders from any provider."
        )
        ...
        self.assertEqual(
            inst.term[0].group[0].type.coding[0].code, "withhold-object-type"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.term[0].group[1].offer.text,
            "Withhold order results from any provider.",
        )
        self.assertEqual(
            inst.term[0].group[1].subType.coding[0].code, "DiagnosticReport"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.term[0].group[1].type.coding[0].code, "withhold-object-type"
        )
        self.assertEqual(
    ...
    def implContract5(self, inst):
        self.assertEqual(
            inst.applies.start.datetime,
            FHIRDateTime("2013-11-01T21:18:27-04:00").datetime,
        )
        ...
        self.assertEqual(
            inst.issued.datetime, FHIRDateTime("2013-11-01T21:18:27-04:00").datetime
        )
        ...
        self.assertEqual(
            ...
            FHIRInstant("2016-07-19T18:18:42.108-04:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.signer[0].signature[0].type[0].code, "1.2.840.10065.1.12.1.1"
        )
        self.assertEqual(
            inst.signer[0].signature[0].type[0].system, "urn:iso-astm:E1762-95:2013"
        )
        self.assertEqual(
            inst.signer[0].signature[0].when.datetime,
            FHIRInstant("2017-02-08T10:57:34+01:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.signer[0].type.system, "http://mdhhs.org/fhir/consent-signer-type"
        )
        ...
        self.assertEqual(
            inst.term[0].action[0].subject[0].role.coding[0].display, "Recipient"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.term[0].action[0].subject[1].role.coding[0].display, "Sender"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.term[0].asset[0].period[0].end.datetime,
            FHIRDateTime("2019-11-01T21:18:27-04:00").datetime,
        )
        self.assertEqual(
            inst.term[0].asset[0].period[0].end.as_json(), "2019-11-01T21:18:27-04:00"
        )
        self.assertEqual(
            inst.term[0].asset[0].period[0].start.datetime,
            FHIRDateTime("2013-11-01T21:18:27-04:00").datetime,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.type.coding[0].system, "http://mdhhs.org/fhir/consentdirective-type"
        )
    ...
    def implContract6(self, inst):
        self.assertEqual(
            inst.applies.start.datetime, FHIRDateTime("2017-01-01").datetime
        )
        ...
        self.assertEqual(
            inst.term[0].asset[0].period[0].start.datetime,
            FHIRDateTime("2017-06-01").datetime,
        )
        ...
        self.assertEqual(
            inst.term[0].asset[0].type[0].coding[0].code, "RicardianContract"
        )
        self.assertEqual(
            inst.term[0].asset[0].type[0].coding[0].system, "urn:ietf:rfc:3986"
        )
        self.assertEqual(
            inst.term[0].asset[0].valuedItem[0].effectiveTime.datetime,
            FHIRDateTime("1995").datetime,
        )
        self.assertEqual(
            inst.term[0].asset[0].valuedItem[0].effectiveTime.as_json(), "1995"
        )
        self.assertEqual(
            inst.term[0].asset[0].valuedItem[0].entityCodeableConcept.text,
            "Ford Bobcat",
        )
        ...
        self.assertEqual(
            inst.term[0].asset[0].valuedItem[0].identifier.value, "XXSVT34-7665t952236"
        )
        ...
        self.assertEqual(
            inst.term[0].group[2].group[0].group[0].offer.text, "Emergency Room Copay"
        )
        self.assertEqual(
            inst.term[0].group[2].group[0].group[1].offer.text,
            "Professional Visit Copay",
        )
        self.assertEqual(inst.term[0].group[2].group[0].offer.text, "Copays")
        self.assertEqual(
            inst.term[0].group[2].group[1].offer.text, "Calendar Year Deductible"
        )
        self.assertEqual(
            inst.term[0].group[2].group[2].offer.text, "Out-Of-Pocket Maximum"
        )
        self.assertEqual(
            inst.term[0].group[2].group[3].group[0].offer.text, "Ambulance Services"
        )
        self.assertEqual(
            inst.term[0].group[2].group[3].group[1].offer.text, "Dental Services"
        )
        self.assertEqual(
            inst.term[0].group[2].group[3].group[2].offer.text, "Diagnostic Services"
        )
        self.assertEqual(
            inst.term[0].group[2].group[3].group[3].offer.text,
            "Emergency Room Services",
        )
        self.assertEqual(
            inst.term[0].group[2].group[3].group[4].offer.text,
    ...
    def implContract7(self, inst):
        ...
        self.assertEqual(
            inst.legallyBindingAttachment.url, "http://www.aws3.com/storage/doc.pdf"
        )
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(
    ...
    def implContract8(self, inst):
        ...
        self.assertEqual(
            inst.signer[0].signature[0].when.datetime,
            FHIRInstant("2013-06-08T10:57:34-07:00").datetime,
        )
        self.assertEqual(
