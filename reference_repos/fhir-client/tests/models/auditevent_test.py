...
class AuditEventTests(unittest.TestCase):
    ...
    def implAuditEvent1(self, inst):
        ...
        self.assertEqual(
            inst.agent[1].network.address, "Workstation1.ehr.familyclinic.com"
        )
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2013-06-20T23:42:24Z").datetime
        )
        ...
        self.assertEqual(
            inst.subtype[0].system, "http://hl7.org/fhir/restful-interaction"
        )
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type.code, "rest")
        self.assertEqual(inst.type.display, "Restful Operation")
        self.assertEqual(
            inst.type.system, "http://terminology.hl7.org/CodeSystem/audit-event-type"
        )
    ...
    def implAuditEvent2(self, inst):
        ...
        self.assertEqual(
            inst.agent[1].purposeOfUse[0].coding[0].display, "healthcare marketing"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.purposeOfEvent[0].coding[0].display, "healthcare marketing"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.type.system, "http://dicom.nema.org/resources/ontology/DCM"
        )
    ...
    def implAuditEvent3(self, inst):
        ...
        self.assertEqual(
            inst.entity[1].type.system, "http://hl7.org/fhir/resource-types"
        )
        ...
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2017-09-07T23:42:24Z").datetime
        )
    ...
    def implAuditEvent4(self, inst):
        ...
        self.assertEqual(
            inst.agent[2].media.system, "http://dicom.nema.org/resources/ontology/DCM"
        )
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2015-08-27T23:42:24Z").datetime
        )
    ...
    def implAuditEvent5(self, inst):
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2013-06-20T23:46:41Z").datetime
        )
        ...
        self.assertEqual(
            inst.subtype[0].system, "http://dicom.nema.org/resources/ontology/DCM"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implAuditEvent6(self, inst):
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2013-06-20T23:41:23Z").datetime
        )
    ...
    def implAuditEvent7(self, inst):
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2012-10-25T22:04:27+11:00").datetime
        )
        ...
        self.assertEqual(
            inst.source.type[0].system, "http://dicom.nema.org/resources/ontology/DCM"
        )
    ...
    def implAuditEvent8(self, inst):
        ...
        self.assertEqual(
            inst.agent[0].network.address, "Workstation1.ehr.familyclinic.com"
        )
        self.assertEqual(inst.agent[0].network.type, "1")
        self.assertFalse(inst.agent[0].requestor)
        self.assertEqual(inst.agent[0].type.coding[0].code, "110153")
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2015-08-26T23:42:24Z").datetime
        )
    ...
    def implAuditEvent9(self, inst):
        ...
        self.assertEqual(inst.outcome, "0")
        self.assertEqual(
            inst.recorded.datetime, FHIRInstant("2015-08-22T23:42:24Z").datetime
        )
