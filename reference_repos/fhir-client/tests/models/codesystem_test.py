...
class CodeSystemTests(unittest.TestCase):
    ...
    def implCodeSystem1(self, inst):
        ...
        self.assertEqual(
            inst.useContext[0].code.system, "http://example.org/CodeSystem/contexttype"
        )
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].code, "337915000"
        )
        self.assertEqual(
    ...
    def implCodeSystem2(self, inst):
        ...
        self.assertEqual(
            inst.concept[7].definition, "A set of protocols to be followed."
        )
        ...
        self.assertEqual(
            inst.identifier[0].value, "urn:oid:2.16.840.1.113883.4.642.4.1105"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.valueSet, "http://hl7.org/fhir/ValueSet/list-example-codes"
        )
        self.assertEqual(inst.version, "4.0.1")
    ...
    def implCodeSystem3(self, inst):
        ...
        self.assertEqual(inst.identifier[0].system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier[0].value, "urn:oid:2.16.840.1.113883.4.642.4.859"
        )
        self.assertEqual(
            inst.meta.lastUpdated.datetime,
            FHIRInstant("2019-11-01T09:29:23.356+11:00").datetime,
        ...
        self.assertEqual(
            inst.valueSet, "http://hl7.org/fhir/ValueSet/examplescenario-actor-type"
        )
        self.assertEqual(inst.version, "4.0.1")
    ...
    def implCodeSystem4(self, inst):
        ...
        self.assertEqual(
            inst.concept[0].designation[0].use.system,
        ...
        self.assertEqual(
            inst.concept[1].designation[0].use.system,
            "http://acme.com/config/fhir/codesystems/internal",
        )
        ...
        self.assertEqual(
            inst.concept[2].designation[0].use.system,
            "http://acme.com/config/fhir/codesystems/internal",
        )
        self.assertEqual(
            inst.concept[2].designation[0].value,
        ...
        self.assertEqual(
            inst.filter[0].description,
            "An internal filter used to select codes that are only used with plasma",
        )
        self.assertEqual(inst.filter[0].operator[0], "=")
        self.assertEqual(
            inst.filter[0].value, "the value of this filter is either 'true' or 'false'"
        )
        self.assertEqual(inst.id, "example")
        self.assertEqual(
            inst.identifier[0].system, "http://acme.com/identifiers/codesystems"
        )
    ...
    def implCodeSystem5(self, inst):
        ...
        self.assertEqual(
            inst.property[0].description, "hether the test is currently performed"
        )
