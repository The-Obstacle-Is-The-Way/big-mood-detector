...
class MeasureTests(unittest.TestCase):
    ...
    def implMeasure1(self, inst):
        ...
        self.assertEqual(
            inst.group[0].population[0].code.coding[0].code, "initial-population"
        )
        self.assertEqual(
            inst.group[0].population[0].criteria.expression, "Initial Population"
        )
    ...
    def implMeasure2(self, inst):
        ...
        self.assertEqual(
            inst.author[0].name, "National Committee for Quality Assurance"
        )
        ...
        self.assertEqual(
            inst.effectivePeriod.start.datetime, FHIRDateTime("2017-01-01").datetime
        )
        ...
        self.assertEqual(
            inst.group[0].population[2].criteria.expression, "CMS146.InDenominator"
        )
        self.assertEqual(inst.group[0].population[2].criteria.language, "text/cql")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.group[0].stratifier[0].code.text, "stratifier-ages-up-to-9"
        )
        self.assertEqual(
            inst.group[0].stratifier[0].criteria.expression, "CMS146.AgesUpToNine"
        )
        self.assertEqual(inst.group[0].stratifier[0].criteria.language, "text/cql")
        self.assertEqual(
            inst.group[0].stratifier[1].code.text, "stratifier-ages-10-plus"
        )
        self.assertEqual(
            inst.group[0].stratifier[1].criteria.expression, "CMS146.AgesTenPlus"
        )
        ...
        self.assertEqual(
            inst.group[0].stratifier[2].criteria.expression, "Patient.gender"
        )
        ...
        self.assertEqual(
            inst.supplementalData[1].code.text, "supplemental-data-deceased"
        )
        self.assertEqual(
            inst.supplementalData[1].criteria.expression, "deceasedBoolean"
        )
        self.assertEqual(inst.supplementalData[1].criteria.language, "text/fhirpath")
        self.assertEqual(inst.text.status, "additional")
        self.assertEqual(
            inst.title, "Appropriate Testing for Children with Pharyngitis"
        )
        ...
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.text, "eligibile-provider"
        )
    ...
    def implMeasure4(self, inst):
        ...
        self.assertEqual(
            inst.group[0].population[0].criteria.expression, "InitialPopulation1"
        )
        self.assertEqual(inst.group[0].population[0].criteria.language, "text/cql")
        self.assertEqual(inst.group[0].population[1].code.coding[0].code, "denominator")
        self.assertEqual(
            inst.group[0].population[1].criteria.expression, "Denominator1"
        )
        self.assertEqual(inst.group[0].population[1].criteria.language, "text/cql")
        self.assertEqual(
        ...
        self.assertEqual(
            inst.group[0].population[2].criteria.expression, "DenominatorExclusions1"
        )
        self.assertEqual(inst.group[0].population[2].criteria.language, "text/cql")
        ...
        self.assertEqual(
            inst.group[1].population[0].code.coding[0].code, "initial-population"
        )
        self.assertEqual(
            inst.group[1].population[0].criteria.expression, "InitialPopulation2"
        )
        ...
        self.assertEqual(
            inst.group[1].population[1].criteria.expression, "Denominator2"
        )
        ...
        self.assertEqual(
            inst.group[1].population[2].criteria.expression, "DenominatorExclusions2"
        )
        ...
        self.assertEqual(
            inst.library[0], "Library/library-exclusive-breastfeeding-cqm-logic"
        )
        self.assertEqual(inst.meta.tag[0].code, "HTEST")
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(
    ...
    def implMeasure5(self, inst):
        ...
        self.assertEqual(
            inst.relatedArtifact[0].resource, "Measure/component-a-example"
        )
        self.assertEqual(inst.relatedArtifact[0].type, "composed-of")
        self.assertEqual(
            inst.relatedArtifact[1].resource, "Measure/component-b-example"
        )
