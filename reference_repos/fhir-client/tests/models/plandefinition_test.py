...
class PlanDefinitionTests(unittest.TestCase):
    ...
    def implPlanDefinition1(self, inst):
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].action[0].action[0].id, "action-1"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].action[0].action[1].id, "action-2"
        )
        self.assertEqual(
            inst.action[0]
            .action[0]
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].action[0].id, "cycle-definition-1"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].groupingBehavior, "sentence-group"
        )
        self.assertEqual(
            inst.action[0].action[0].action[0].selectionBehavior, "exactly-one"
        )
        ...
        self.assertEqual(
            inst.relatedArtifact[1].url, "http://www.ncbi.nlm.nih.gov/pubmed/17437788"
        )
        ...
        self.assertEqual(
            inst.useContext[0].code.code, "treamentSetting-or-diseaseStatus"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[3].code.code, "treatmentSetting-or-diseaseStatus"
        )
        self.assertEqual(
    ...
    def implPlanDefinition2(self, inst):
        ...
        self.assertEqual(
            inst.action[0].action[0].condition[0].expression.language, "text/cql"
        )
        ...
        self.assertEqual(
            inst.action[0].action[1].condition[0].expression.language, "text/cql"
        )
        ...
        self.assertEqual(
            inst.action[0].action[2].condition[0].expression.language, "text/cql"
        )
        ...
        self.assertEqual(
            inst.action[0].action[3].condition[0].expression.language, "text/cql"
        )
        self.assertEqual(inst.action[0].action[3].condition[0].kind, "applicability")
        self.assertEqual(
            inst.action[0].action[3].definitionCanonical,
            "ActivityDefinition/consider-igm-antibody-testing",
        )
        self.assertEqual(
            inst.action[0].action[4].action[0].definitionCanonical,
        ...
        self.assertEqual(
            inst.action[0].action[4].condition[0].expression.language, "text/cql"
        )
        self.assertEqual(inst.action[0].action[4].condition[0].kind, "applicability")
        self.assertEqual(
            inst.action[0].condition[0].expression.expression, "Is Patient Pregnant"
        )
        ...
        self.assertEqual(
            inst.relatedArtifact[1].resource, "PlanDefinition/zika-virus-intervention"
        )
        ...
        self.assertEqual(
            inst.url, "http://example.org/PlanDefinition/zika-virus-intervention"
        )
    ...
    def implPlanDefinition3(self, inst):
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[0].path, "timing.event"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[1].path, "specialty"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[2].path,
            "occurrenceDateTime",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[4].path, "requester.agent"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[5].path, "reasonCode"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[0].action[0].dynamicValue[6].path, "reasonReference"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[1].action[0].action[0].groupingBehavior,
            "logical-group",
        )
        self.assertEqual(
            inst.action[0].action[1].action[0].action[0].selectionBehavior,
            "at-most-one",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[1].action[0].documentation[0].type, "citation"
        )
        self.assertEqual(
            inst.action[0].action[1].action[0].groupingBehavior, "logical-group"
        )
        self.assertEqual(
            inst.action[0].action[1].action[0].selectionBehavior, "at-most-one"
        )
        self.assertEqual(
            inst.action[0].action[1].action[0].title, "First-Line Antidepressants"
        )
        ...
        self.assertEqual(
            inst.action[0].title, "Suicide Risk Assessment and Outpatient Management"
        )
        ...
        self.assertEqual(
            inst.effectivePeriod.end.datetime, FHIRDateTime("2017-12-31").datetime
        )
        self.assertEqual(inst.effectivePeriod.end.as_json(), "2017-12-31")
        self.assertEqual(
            inst.effectivePeriod.start.datetime, FHIRDateTime("2016-01-01").datetime
        )
        ...
        self.assertEqual(
            inst.relatedArtifact[2].resource,
        ...
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].display, "Adult"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[1].valueCodeableConcept.coding[0].code, "87512008"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[2].valueCodeableConcept.coding[0].code, "40379007"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[3].valueCodeableConcept.coding[0].code, "394687007"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[4].valueCodeableConcept.coding[0].code, "225337009"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[5].valueCodeableConcept.coding[0].display, "Physician"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[6].valueCodeableConcept.coding[0].code, "440655000"
        )
        self.assertEqual(
    ...
    def implPlanDefinition4(self, inst):
        ...
        self.assertEqual(
            inst.action[0].action[1].relatedAction[0].actionId, "medication-action-1"
        )
        self.assertEqual(
            inst.action[0].action[1].relatedAction[0].offsetDuration.unit, "h"
        )
        self.assertEqual(
            inst.action[0].action[1].relatedAction[0].offsetDuration.value, 1
        )
        self.assertEqual(
            inst.action[0].action[1].relatedAction[0].relationship, "after-end"
        )
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.title, "This example illustrates relationships between actions."
        )
    ...
    def implPlanDefinition5(self, inst):
        ...
        self.assertEqual(
            inst.action[0].action[0].action[1].title,
        ...
        self.assertEqual(
            inst.action[0].action[0].action[2].title, "Goal of cardiology consultation"
        )
        self.assertEqual(inst.action[0].action[0].groupingBehavior, "logical-group")
        self.assertEqual(inst.action[0].action[0].selectionBehavior, "any")
        self.assertEqual(inst.action[0].action[0].title, "Consults and Referrals")
        ...
        self.assertEqual(
            inst.action[0].action[1].action[1].action[0].dynamicValue[0].path, "status"
        )
        self.assertEqual(
            inst.action[0]
            .action[1]
        ...
        self.assertEqual(
            inst.action[0].action[1].action[1].action[1].dynamicValue[0].path, "status"
        )
        self.assertEqual(
            inst.action[0]
            .action[1]
        ...
        self.assertEqual(
            inst.action[0].action[1].action[1].action[2].dynamicValue[0].path, "status"
        )
        self.assertEqual(
            inst.action[0]
            .action[1]
        ...
        self.assertEqual(
            inst.action[0].action[1].action[1].groupingBehavior, "logical-group"
        )
        self.assertEqual(
            inst.action[0].action[1].action[1].selectionBehavior, "at-most-one"
        )
        self.assertEqual(
            inst.action[0].action[1].action[1].title, "Antianginal Therapy"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.action[0].action[1].action[2].action[0].dynamicValue[0].path, "status"
        )
        self.assertEqual(
            inst.action[0]
            .action[1]
        ...
        self.assertEqual(
            inst.action[0].action[1].action[2].groupingBehavior, "logical-group"
        )
        self.assertEqual(
            inst.action[0].action[1].action[2].selectionBehavior, "at-most-one"
        )
        ...
        self.assertEqual(inst.identifier[0].use, "official")
        self.assertEqual(
            inst.identifier[0].value, "bb7ccea6-9744-4743-854a-bcffd87191f6"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.identifier[2].system, "urn:cognitivemedicine.com:lab:jira"
        )
        ...
        self.assertEqual(
            inst.relatedArtifact[9].display,
        ...
        self.assertEqual(
            inst.url, "http://va.gov/kas/orderset/B5-Cardiology-ChestPainCAD-OS"
        )
        ...
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].code, "look up value"
        )
        self.assertEqual(
    ...
    def implPlanDefinition6(self, inst):
        ...
        self.assertEqual(
            inst.author[0].name, "National Heart, Lung, and Blood Institute"
        )
        ...
        self.assertEqual(
            inst.goal[0].addresses[0].coding[0].display, "Obesity (disorder)"
        )
        self.assertEqual(
            inst.goal[0].addresses[0].coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(inst.goal[0].category.text, "Treatment")
        self.assertEqual(inst.goal[0].description.text, "Reduce BMI to below 25")
        self.assertEqual(
            inst.goal[0].documentation[0].display, "Evaluation and Treatment Strategy"
        )
        ...
        self.assertEqual(
            inst.goal[0].start.text, "When the patient's BMI Ratio is at or above 25"
        )
        ...
        self.assertEqual(
            inst.goal[0].target[0].measure.coding[0].system, "http://loinc.org"
        )
        ...
        self.assertEqual(inst.useContext[0].code.code, "focus")
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].code, "414916001"
        )
        self.assertEqual(
            inst.useContext[0].valueCodeableConcept.coding[0].display,
            "Obesity (disorder)",
