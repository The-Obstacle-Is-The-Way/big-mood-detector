...
class MediaTests(unittest.TestCase):
    ...
    def implMedia1(self, inst):
        ...
        self.assertEqual(
            inst.content.creation.datetime, FHIRDateTime("2016-03-15").datetime
        )
        self.assertEqual(inst.content.creation.as_json(), "2016-03-15")
        self.assertEqual(inst.content.id, "a1")
        self.assertEqual(
            inst.content.url, "http://someimagingcenter.org/fhir/Binary/A12345"
        )
        self.assertEqual(
            inst.createdDateTime.datetime, FHIRDateTime("2016-03-15").datetime
        )
    ...
    def implMedia2(self, inst):
        ...
        self.assertEqual(
            inst.id, "1.2.840.11361907579238403408700.3.1.04.19970327150033"
        )
    ...
    def implMedia3(self, inst):
        ...
        self.assertEqual(
            inst.content.creation.datetime, FHIRDateTime("2009-09-03").datetime
        )
        self.assertEqual(inst.content.creation.as_json(), "2009-09-03")
        self.assertEqual(inst.content.id, "a1")
        self.assertEqual(
            inst.createdDateTime.datetime, FHIRDateTime("2017-12-17").datetime
        )
        ...
        self.assertEqual(
            inst.issued.datetime, FHIRInstant("2017-12-17T14:56:18Z").datetime
        )
