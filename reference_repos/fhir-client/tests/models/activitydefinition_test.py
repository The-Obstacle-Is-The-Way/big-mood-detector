...
class ActivityDefinitionTests(unittest.TestCase):
    ...
    def implActivityDefinition2(self, inst):
        ...
        self.assertEqual(
            inst.date.datetime, FHIRDateTime("2017-03-03T14:06:00Z").datetime
        )
        ...
        self.assertEqual(
            inst.useContext[3].valueCodeableConcept.coding[0].code, "225444004"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[4].valueCodeableConcept.coding[0].code, "306206005"
        )
        self.assertEqual(
    ...
    def implActivityDefinition3(self, inst):
        ...
        self.assertEqual(
            inst.dosage[0].doseAndRate[0].type.coding[0].display, "Ordered"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.dosage[0].route.coding[0].display, "Oral route (qualifier value)"
        )
        ...
        self.assertEqual(
            inst.dynamicValue[0].path, "dispenseRequest.numberOfRepeatsAllowed"
        )
        self.assertEqual(
    ...
    def implActivityDefinition4(self, inst):
        ...
        self.assertEqual(
            inst.participant[0].role.coding[0].display, "Interventional Cardiology"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.useContext[1].valueCodeableConcept.coding[0].code, "309343006"
        )
        self.assertEqual(
            inst.useContext[1].valueCodeableConcept.coding[0].display, "Physician"
        )
        self.assertEqual(
            inst.useContext[1].valueCodeableConcept.coding[0].system,
            "http://snomed.info/sct",
    ...
    def implActivityDefinition5(self, inst):
        ...
        self.assertEqual(inst.effectivePeriod.end.as_json(), "2017-12-31")
        self.assertEqual(
            inst.effectivePeriod.start.datetime, FHIRDateTime("2017-03-01").datetime
        )
