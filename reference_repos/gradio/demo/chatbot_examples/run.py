...
with gr.Blocks(fill_height=True) as demo:
    chatbot = gr.Chatbot(
        ...
        examples=[
            {
                "icon": os.path.join(os.path.dirname(__file__), "files/avatar.png"),
            ...
            },
            {
                ...
                "files": [os.path.join(os.path.dirname(__file__), "files/avatar.png")],
            },
            {"text": "This is just text, no files!"},
            {
                "text": "Try this example with this image.",
                "files": [
                    os.path.join(os.path.dirname(__file__), "files/avatar.png"),
                    os.path.join(os.path.dirname(__file__), "files/avatar.png"),
                ],
            },
            {
    ...
    chatbot.example_select(append_example_message, [chatbot], [chatbot]).then(
        respond, chatbot, chatbot, api_name="respond"
    )
