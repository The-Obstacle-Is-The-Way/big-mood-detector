...
class PATSequence:
    ...
    def to_patches(self, patch_size: int = 18) -> np.ndarray:
        ...
        return self.activity_values[:num_patches * patch_size].reshape(num_patches, patch_size)
...
class PATSequenceBuilder:
    ...
    def _combine_sequences(self, daily_sequences: List[MinuteLevelSequence]) -> np.ndarray:
        """
