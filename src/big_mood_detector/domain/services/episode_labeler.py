...
class EpisodeLabeler:
    ...
    def add_episode(
        ...
        *args: Any,
        ...
        if date:
            ...
            episode["end_date"] = end_date if isinstance(end_date, str) else end_date.isoformat()
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        if not rows:
            ...
            return pd.DataFrame(columns=["date", "label", "severity", "confidence", "model_agreed", "rater_id"])
