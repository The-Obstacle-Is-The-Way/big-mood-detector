...
class SleepFeatureCalculator:
    ...
    def calculate_regularity_index(self, sleep_summaries: list[DailySleepSummary]) -> float:
        ...
        for summary in sleep_summaries:
            ...
            sleep_hour = summary.sleep_onset.hour + summary.sleep_onset.minute / 60
            ...
            # Wake times
            wake_hour = summary.wake_time.hour + summary.wake_time.minute / 60
    ...
    def calculate_interdaily_stability(self, sleep_summaries: list[DailySleepSummary]) -> float:
        ...
        for summary in sleep_summaries:
            ...
            # Mark sleep hours as active (1)
            sleep_start = summary.sleep_onset.hour
            sleep_end = summary.wake_time.hour
    ...
    def calculate_intradaily_variability(self, sleep_summaries: list[DailySleepSummary]) -> float:
        ...
        # Use awakenings and efficiency as fragmentation indicators
        fragmentation_scores = []
        
        for summary in sleep_summaries:
            # Higher awakenings = more fragmentation
            awakening_score = min(summary.awakenings / 10, 1.0)
            
            # Lower efficiency = more fragmentation
            efficiency_score = 1.0 - summary.sleep_efficiency
            
            # Combined fragmentation
            fragmentation = (awakening_score + efficiency_score) / 2
