...
class StoredSleepRecord:
    ...
    @classmethod
    def from_domain(cls, record: SleepRecord, record_id: str | None = None) -> "StoredSleepRecord":
...
class StoredActivityRecord:
    ...
    @classmethod
    def from_domain(cls, record: ActivityRecord, record_id: str | None = None) -> "StoredActivityRecord":
        """Create stored record from domain entity."""
        if record_id is None:
            # Generate ID from record properties
...
class StoredHeartRateRecord:
    ...
    @classmethod
    def from_domain(cls, record: HeartRateRecord, record_id: str | None = None) -> "StoredHeartRateRecord":
        """Create stored record from domain entity."""
        if record_id is None:
            # Generate ID from record properties
