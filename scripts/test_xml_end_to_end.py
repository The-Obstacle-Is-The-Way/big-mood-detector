...
def test_activity_extraction(activity_records):
    ...
    dates = sorted(set(r.start_date.date() for r in activity_records))[-30:]
...
def run_complete_test():
    ...
    print(f"   XML Parsing: ~17s")
    print(f"   Sleep Analysis: <0.1s")
    print(f"   Activity Extraction: ~1s")
    print(f"   Feature Engineering: <1s")
    print(f"   ML Predictions: <0.5s")
    print(f"   Clinical Interpretation: <0.1s")
    print(f"\n🎯 End-to-End Success:")
