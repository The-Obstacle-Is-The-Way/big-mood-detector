...
def debug_parser():
    ...
    for event, elem in ET.iterparse(str(xml_file), events=('end',)):
        if event == 'end' and elem.tag == 'Record':
            ...
            # Check for sleep
            if record_type == 'HKCategoryTypeIdentifierSleepAnalysis' and not found_sleep:
                found_sleep = True
            ...
            # Check for steps
            elif record_type == 'HKQuantityTypeIdentifierStepCount' and not found_activity:
                found_activity = True
    ...
    # Test sleep records
    sleep_records = list(parser.iter_records(
        xml_file, 
    ...
    activity_records = list(parser.iter_records(
        xml_file,
