...
def main():
    ...
    for i, row in enumerate(clinical_data[:5]):
        ...
        print(f"    Sleep: {row['sleep_duration_hours']:.1f}h, efficiency: {row['sleep_efficiency']:.1%}")
    ...
    if clinical_data:
        ...
        numeric_features = [
            'sleep_duration_hours', 'sleep_efficiency', 'total_steps',
            'avg_resting_hr', 'hrv_sdnn', 'sedentary_hours'
        ]
